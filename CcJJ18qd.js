import{b as s}from"./4TdYTt4D.js";import{i as a,j as p}from"./C6LcZyl8.js";import{R as e,c as n}from"./DxdnUrFn.js";import{l}from"./C1j50iH-.js";import"./TK2cLds4.js";const c={version:"0.0.1",tocContent:'<ul><li><a href="https://github.com/smikhalevski/mfml#readme">GitHub <sup>↗</sup></a></li><li><a href="https://smikhalevski.github.io/mfml/">API docs <sup>↗</sup></a></li></ul><p><span class="toc-icon">🔰 </span><a href="#quick-start"><strong>Quick start</strong></a></p><p><span class="toc-icon">#️⃣ </span><a href="#syntax"><strong>Syntax</strong></a></p><ul><li><a href="#arguments">Arguments</a></li><li><a href="#types-and-styles">Types and styles</a></li><li><a href="#options">Options</a></li><li><a href="#categories">Categories</a></li><li><a href="#pluralization">Pluralization</a></li></ul><p><span class="toc-icon">⚛️ </span><strong>Rendering</strong></p><ul><li><a href="#render-to-string">Render to string</a></li><li><a href="#react-integration">React integration</a></li><li><a href="#custom-formatters">Custom formatters</a></li></ul><p><span class="toc-icon">⚙️ </span><a href="#configuration"><strong>Configuration</strong></a></p><ul><li><a href="#messages"><code>messages</code></a></li><li><a href="#outdir"><code>outDir</code></a></li><li><a href="#packagename"><code>packageName</code></a></li><li><a href="#fallbacklocales"><code>fallbackLocales</code></a></li><li><a href="#preprocessors"><code>preprocessors</code></a></li><li><a href="#postprocessors"><code>postprocessors</code></a></li><li><a href="#renamemessagefunction"><code>renameMessageFunction</code></a></li><li><a href="#decodetext"><code>decodeText</code></a></li><li><a href="#getargumenttstype"><code>getArgumentTSType</code></a></li><li><a href="#tokenizeroptions"><code>tokenizerOptions</code></a></li></ul><p><span class="toc-icon">🪵 </span><a href="#tokenizing-messages"><strong>Tokenizing messages</strong></a></p><ul><li><a href="#voidtags"><code>voidTags</code></a></li><li><a href="#rawtexttags"><code>rawTextTags</code></a></li><li><a href="#implicitlyclosedtags"><code>implicitlyClosedTags</code></a></li><li><a href="#implicitlyopenedtags"><code>implicitlyOpenedTags</code></a></li><li><a href="#iscaseinsensitivetags"><code>isCaseInsensitive​Tags</code></a></li><li><a href="#isselfclosingtagsrecognized"><code>isSelfClosingTags​Recognized</code></a></li><li><a href="#isunbalancedstarttagsimplicitlyclosed"><code>isUnbalancedStart​Tags​Implicitly​Closed</code></a></li><li><a href="#isunbalancedendtagsignored"><code>isUnbalancedEndTags​Ignored</code></a></li><li><a href="#israwtextinterpolated"><code>isRawText​Interpolated</code></a></li><li><a href="#isoctothorperecognized"><code>isOctothorpe​Recognized</code></a></li></ul><p><span class="toc-icon">🌲 </span><a href="#parsing-messages"><strong>Parsing messages</strong></a></p><p><span class="toc-icon">🎯 </span><a href="#motivation"><strong>Motivation</strong></a></p>',articleContent:`<!--OVERVIEW--><p>The <a href="https://unicode-org.github.io/icu/userguide/format_parse/messages/">ICU MessageFormat <sup>↗</sup></a> + XML/HTML compiler and runtime that makes your i18n messages tree-shakeable.</p><ul><li>TypeScript-first.</li><li>Tree-shakeable messages: colocates messages with related code.</li><li>Integrates with any translation management system.</li><li>Highly customizable.</li><li>First-class React support.</li><li>Zero dependencies.</li><li>XSS-resilient rendering: no dangerous HTML rendering.</li><li><a href="https://bundlephobia.com/result?p=mfml">Just 3 kB gzipped. <sup>↗</sup></a></li></ul><!--/OVERVIEW--><br><pre><code class="language-sh">npm install --save-prod mfml
  ...
  <span class="pl-ent">"ru"</span>: {
    <span class="pl-ent">"greeting"</span>: <span class="pl-s"><span class="pl-pds">"</span>Привет, &#x3C;b>{name}&#x3C;/b>!<span class="pl-pds">"</span></span>
  }
}
</code></pre><p>Put your config in <em>mfml.config.js</em>:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">defineConfig</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml/compiler<span class="pl-pds">'</span></span>;
...
<span class="pl-c">// ⮕ 'Hello, Bob!'</span>
...
</code></pre><p>Now, your bundler would do all the heavy lifting and colocate message functions with components that import them in the same chunk.</p><h1 id="syntax"><a class="markdown-permalink" href="#syntax"><span class="icon icon-link"></span></a>Syntax</h1><p>The MFML syntax is a hybrid of the <a href="https://unicode-org.github.io/icu/userguide/format_parse/messages/">ICU MessageFormat <sup>↗</sup></a> syntax and XML/HTML.</p><p>ICU MessageFormat is a templating syntax designed for internationalized messages. It allows developers to insert variables, handle pluralization, gender, and select logic in a locale-aware way. MFML supports all ICU MessageFormat features and allows to customize and extend them.</p><p>MFML borrows basic arguments syntax from the MessageFormat:</p><pre><code>{name}
</code></pre><p>And formatted arguments syntax:</p><pre><code>{age, number, integer}
</code></pre><p>And select over argument categories syntax:</p><pre><code>{gender, select,
  male { He is a # }
  female { She is a # }
}
</code></pre><p>Pluralization is handled through argument categories as well:</p><pre><code>You have {messageCount, plural,
  one { one message }
  other { # messages }
}
</code></pre><p>Form XML/HTML, MFML borrows tags and attributes:</p><pre><code class="language-html">Hello, &#x3C;<span class="pl-ent">strong</span>>{name}&#x3C;/<span class="pl-ent">strong</span>>!
...
</code></pre><p>You can use your custom tags and <a href="#custom-renderer">setup a custom renderer to properly display them</a>:</p><pre><code class="language-html">&#x3C;<span class="pl-ent">Hint</span> <span class="pl-e">title</span>=<span class="pl-s"><span class="pl-pds">"</span>Final offer at {discount, percent} discount!<span class="pl-pds">"</span></span>>{price}&#x3C;/<span class="pl-ent">Hint</span>>
...
</code></pre><p>Here, <code>{name}</code> is an argument that doesn't impose any formatting on its value. By default, during interpolation, the actual value is cast to a string. Spaces around the argument name are ignored, so this yield the same result as:</p><pre><code>Hello, {   name   }!
</code></pre><h2 id="types-and-styles"><a class="markdown-permalink" href="#types-and-styles"><span class="icon icon-link"></span></a>Types and styles</h2><p>Argument values can be formatted during interpolation. Provide an argument type to pick a formatter that should be used:</p><pre><code>You have {count, number} messages.
                 ^^^^^^
</code></pre><p>Here, <code>number</code> is an argument type. By default, <code>number</code> uses a <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat"><code>Intl.NumberFormat</code> <sup>↗</sup></a> for formatting.</p><p>You can provide a style for a formatter:</p><pre><code>Download {progress, number, percent} complete.
                            ^^^^^^^
</code></pre><p>Default configuration provides following argument types and styles:</p><table><tbody><tr><th align="left">Argument type</th><th align="left">Argument style</th><th align="left">Example, <code>en</code> locale</th><th align="left">Required value type</th></tr><tr><td valign="top" rowspan="5"><code>number</code></td><td>—</td><td>1,000.99</td><td valign="top" rowspan="5"><code>number</code> or <code>bigint</code></td></tr><tr><td><code>decimal</code></td><td>1,000.99</td></tr><tr><td><code>integer</code></td><td>1,000</td></tr><tr><td><code>percent</code></td><td>75%</td></tr><tr><td><code>currency</code></td><td>$1,000.00</td></tr><tr><td valign="top" rowspan="5"><code>date</code></td><td>—</td><td>1/1/1970</td><td valign="top" rowspan="5"><code>number</code> or <code>Date</code></td></tr><tr><td><code>short</code></td><td>1/1/70</td></tr><tr><td><code>medium</code></td><td>Jan 1, 1970</td></tr><tr><td><code>long</code></td><td>January 1, 1970</td></tr><tr><td><code>full</code></td><td>Thursday, January 1, 1970</td></tr><tr><td valign="top" rowspan="5"><code>time</code></td><td>—</td><td>12:00 AM</td><td valign="top" rowspan="5"><code>number</code> or <code>Date</code></td></tr><tr><td><code>short</code></td><td>12:00 AM</td></tr><tr><td><code>medium</code></td><td>12:00:00 AM</td></tr><tr><td><code>long</code></td><td>12:00:00 AM UTC</td></tr><tr><td><code>full</code></td><td>12:00:00 AM Coordinated Universal Time</td></tr><tr><td valign="top" rowspan="4"><code>conjunction</code></td><td>—</td><td>A, B, and C</td><td valign="top" rowspan="4"><code>string[]</code></td></tr><tr><td><code>narrow</code></td><td>A, B, C</td></tr><tr><td><code>short</code></td><td>A, B, &#x26; C</td></tr><tr><td><code>long</code></td><td>A, B, and C</td></tr><tr><td valign="top" rowspan="4"><code>disjunction</code></td><td>—</td><td>A, B, or C</td><td valign="top" rowspan="4"><code>string[]</code></td></tr><tr><td><code>narrow</code></td><td>A, B, or C</td></tr><tr><td><code>short</code></td><td>A, B, or C</td></tr><tr><td><code>long</code></td><td>A, B, or C</td></tr></tbody></table><h2 id="options"><a class="markdown-permalink" href="#options"><span class="icon icon-link"></span></a>Options</h2><p>Instead of using a predefined style, you can provide a set of options for a formatter:</p><pre><code>{propertyArea, number,
  style=unit
  unit=acre
  unitDisplay=long
}
</code></pre><p>Here <a href="https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat/NumberFormat#style"><code>style</code> <sup>↗</sup></a>, <a href="https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat/NumberFormat#unit"><code>unit</code> <sup>↗</sup></a> and <a href="https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat/NumberFormat#unitDisplay"><code>unitDisplay</code> <sup>↗</sup></a> are options of the <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat"><code>Intl.NumberFormat</code> <sup>↗</sup></a>.</p><p>You can find the full list of options for <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat/NumberFormat#style_options"><code>number</code> arguments <sup>↗</sup></a> and for <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat/DateTimeFormat#locale_options"><code>date</code> and <code>time</code> arguments <sup>↗</sup></a> on MDN.</p><h2 id="categories"><a class="markdown-permalink" href="#categories"><span class="icon icon-link"></span></a>Categories</h2><p>Arguments can use categories for conditional rendering. For example, if you want to alter a message depending on a user's gender:</p><pre><code>{gender, select,
  male {He}
  female {She}
  other {They}
}
sent you a message.
</code></pre><p>Value of the <code>gender</code> argument is used for selecting a specific category. If value is <code>"male"</code> then argument placeholder is replaced with "He", if value is <code>"female"</code> then with "She", and for any other value "They" is rendered.</p><p><code>other</code> is a special category: it's value is used if no literal did match. If there's no matching category in <code>select</code> and no <code>other</code> category then argument placeholder is replaced with an empty string.</p><p>Be sure to always provide the <code>other</code> category as a fallback.</p><h2 id="pluralization"><a class="markdown-permalink" href="#pluralization"><span class="icon icon-link"></span></a>Pluralization</h2><p>Numeric argument values can be pluralized in cardinal and ordinal fashion.</p><p>Use <code>plural</code> argument type for cardinal pluralization rules:</p><pre><code>You have {messageCount, plural,
  one {one message}
  other {# messages}
}.
...
<span class="pl-c">// ⮕ 'Hello, __Bob__!'</span>
...
</code></pre><p>Then you can render it with React using <a href="https://smikhalevski.github.io/mfml/functions/mfml_react.Message.html"><code>&#x3C;Message></code> <sup>↗</sup></a> component:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">Message</span>, <span class="pl-smi">MessageLocaleProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml/react<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">greeting</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>@mfml/messages<span class="pl-pds">'</span></span>;
...
<span class="pl-k">export</span> <span class="pl-k">const</span> <span class="pl-en">App</span> <span class="pl-k">=</span> () <span class="pl-k">=></span> (
  ...
  <span class="pl-e">message</span><span class="pl-k">=</span><span class="pl-pse">{</span><span class="pl-smi">greeting</span><span class="pl-pse">}</span>
  <span class="pl-e">values</span><span class="pl-k">=</span><span class="pl-pse">{</span>{ name: &#x3C;<span class="pl-c1">UserAvatar</span>>Bob&#x3C;/<span class="pl-c1">UserAvatar</span>> }<span class="pl-pse">}</span>
/>
</code></pre><p>This would output:</p><!-- prettier-ignore --><pre><code class="language-html">Hello, &#x3C;<span class="pl-ent">b</span>>&#x3C;<span class="pl-ent">UserAvatar</span>>Bob&#x3C;/<span class="pl-ent">UserAvatar</span>>&#x3C;/<span class="pl-ent">b</span>>!
...
<span class="pl-c">// 1️⃣ Create a custom component</span>
...
<span class="pl-c">// 2️⃣ Create a custom renderer</span>
<span class="pl-k">const</span> <span class="pl-c1">myRenderer</span><span class="pl-k">:</span> <span class="pl-en">Renderer</span>&#x3C;<span class="pl-c1">string</span>> <span class="pl-k">=</span> {
...
<span class="pl-k">export</span> <span class="pl-k">const</span> <span class="pl-en">App</span> <span class="pl-k">=</span> () <span class="pl-k">=></span> (
  <span class="pl-c">// 3️⃣ Provide renderer through the context</span>
...
/>
</code></pre><p>This would output:</p><!-- prettier-ignore --><pre><code class="language-html">Final offer: &#x3C;<span class="pl-ent">div</span> <span class="pl-e">title</span>=<span class="pl-s"><span class="pl-pds">'</span>20% discount!<span class="pl-pds">'</span></span>>$1,000&#x3C;/<span class="pl-ent">div</span>>
</code></pre><h1 id="custom-formatters"><a class="markdown-permalink" href="#custom-formatters"><span class="icon icon-link"></span></a>Custom formatters</h1><p>MFML provides the <a href="https://smikhalevski.github.io/mfml/variables/mfml.defaultArgumentFormatter.html"><code>defaultArgumentFormatter</code> <sup>↗</sup></a> that supports <code>number</code>, <code>date</code>, <code>time</code>, <code>conjunction</code> and <code>disjunction</code> argument types and <a href="#types-and-styles">corresponding styles</a>.</p><p>To change how formatters are applied, you should create a custom renderer and provide it to <a href="#render-to-string"><code>renderToString</code></a> or to <a href="#react-integration"><code>&#x3C;Message></code></a> component (as a prop or through a <a href="https://smikhalevski.github.io/mfml/variables/mfml_react.MessageRendererProvider.html"><code>&#x3C;MessageRendererProvider></code> <sup>↗</sup></a>).</p><p>Let's assume we've compiled the message function <code>factAboutUSA</code>:</p><pre><code>USA border length is {borderLength, unitMeter}.
                                   ^^^^^^^^^^^
</code></pre><p>Create a formatter that formats arguments with type <code>unitMeter</code>:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-k">type</span> <span class="pl-smi">ArgumentFormatter</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml<span class="pl-pds">'</span></span>;
...
<span class="pl-k">const</span> <span class="pl-en">unitMeterArgumentFormatter</span><span class="pl-k">:</span> <span class="pl-en">ArgumentFormatter</span> <span class="pl-k">=</span> <span class="pl-v">params</span> <span class="pl-k">=></span> {
  <span class="pl-k">if</span> (<span class="pl-smi">params</span>.<span class="pl-c1">type</span> <span class="pl-k">===</span> <span class="pl-s"><span class="pl-pds">'</span>unitMeter<span class="pl-pds">'</span></span> <span class="pl-k">&#x26;&#x26;</span> <span class="pl-k">typeof</span> <span class="pl-smi">params</span>.<span class="pl-c1">value</span> <span class="pl-k">===</span> <span class="pl-s"><span class="pl-pds">'</span>number<span class="pl-pds">'</span></span>) {
    <span class="pl-k">return</span> <span class="pl-k">new</span> <span class="pl-c1">Intl</span>.<span class="pl-en">NumberFormat</span>(<span class="pl-smi">params</span>.<span class="pl-smi">locale</span>, { style: <span class="pl-s"><span class="pl-pds">'</span>unit<span class="pl-pds">'</span></span>, unit: <span class="pl-s"><span class="pl-pds">'</span>meter<span class="pl-pds">'</span></span> }).<span class="pl-en">format</span>(<span class="pl-smi">params</span>.<span class="pl-c1">value</span>);
  }

  <span class="pl-k">return</span> <span class="pl-smi">params</span>.<span class="pl-c1">value</span>;
};
</code></pre><p>Now, lets crete a renderer that would use this formatter:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">defaultArgumentFormatter</span>, <span class="pl-smi">defaultCategorySelector</span>, <span class="pl-k">type</span> <span class="pl-smi">Renderer</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml<span class="pl-pds">'</span></span>;
...
</code></pre><p>Render a message to string using new custom renderer:</p><pre><code class="language-ts"><span class="pl-en">renderToString</span>({
  message: <span class="pl-smi">factAboutUSA</span>,
  values: { borderLength: <span class="pl-c1">8_891_000</span> },
  locale: <span class="pl-s"><span class="pl-pds">'</span>en<span class="pl-pds">'</span></span>,
  renderer: <span class="pl-smi">myRenderer</span>,
});
<span class="pl-c">// ⮕ 'USA border length is 8,891,000 m.'</span>
</code></pre><p>Usually you want multiple formatters to be available, so MFML provides factories that simplify formatter declaration:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">combineArgumentFormatters</span>, <span class="pl-smi">createNumberArgumentFormatter</span>, <span class="pl-smi">createDateTimeArgumentFormatter</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml<span class="pl-pds">'</span></span>;
...
</code></pre><p><a href="https://smikhalevski.github.io/mfml/functions/mfml_react.combineArgumentFormatters.html"><code>combineArgumentFormatters</code> <sup>↗</sup></a>) creates an argument formatter that sequentially applies each formatter from the list of formatters until one returns a formatted value. If none of the formatters returns a formatted value, then a value returned as-is.</p><p>Of you can fallback to a default formatter:</p><!-- prettier-ignore --><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">combineArgumentFormatters</span>, <span class="pl-smi">defaultArgumentFormatter</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml<span class="pl-pds">'</span></span>;

<span class="pl-k">const</span> <span class="pl-c1">myArgumentFormatter</span> <span class="pl-k">=</span> <span class="pl-en">combineArgumentFormatters</span>([
  <span class="pl-smi">unitMeterArgumentFormatter</span>,
  <span class="pl-smi">defaultArgumentFormatter</span>,
]);
</code></pre><h1 id="configuration"><a class="markdown-permalink" href="#configuration"><span class="icon icon-link"></span></a>Configuration</h1><p>When running <code>mfml</code> from the command line, MFML will automatically try to resolve a config file named <code>mfml.config.js</code> inside the <code>cwd</code> (other JS and TS extensions are also supported).</p><p>The most basic config file looks like this:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">defineConfig</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml/compiler<span class="pl-pds">'</span></span>;
...
<span class="pl-k">export</span> <span class="pl-k">default</span> <span class="pl-en">defineConfig</span>({
  ...
  ru<span class="pl-k">:</span> {
    greeting<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>Привет<span class="pl-pds">'</span></span>,
  },
}
</code></pre><p>It is recommended to store messages in separate files on per-locale basis:</p><!-- prettier-ignore --><pre><code class="language-json5"><span class="pl-c">// en.json</span>
{
...
</code></pre><!-- prettier-ignore --><pre><code class="language-json5"><span class="pl-c">// ru.json</span>
{
  <span class="pl-s"><span class="pl-pds">"</span>greeting<span class="pl-pds">"</span></span><span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>Привет<span class="pl-pds">"</span></span>
}
...
<span class="pl-k">export</span> <span class="pl-k">default</span> <span class="pl-en">defineConfig</span>({
  messages: {
    en: {
      ...
      <span class="pl-c">//          ^^^^ Upper case argument names</span>
    },
  },
...
<span class="pl-c">//                                               ^^^^ Lower case argument names</span>
</code></pre><h2 id="renamemessagefunction"><a class="markdown-permalink" href="#renamemessagefunction"><span class="icon icon-link"></span></a><code>renameMessage​Function</code></h2><p><strong>Default:</strong> <code>messageKey => messageKey</code></p><p>Returns the name of the message function for the given message key.</p><pre><code class="language-ts"><span class="pl-k">export</span> <span class="pl-k">default</span> <span class="pl-en">defineConfig</span>({
  messages: {
    en: {
      greeting: <span class="pl-s"><span class="pl-pds">'</span>Hello<span class="pl-pds">'</span></span>,
    },
...
<span class="pl-c">// ⮕ 'Hello'</span>
</code></pre><p>Message function names are always escaped; illegal characters are replaced with underscores.</p><p>Compilation fails if the same function name is returned for different message keys.</p><h2 id="decodetext"><a class="markdown-permalink" href="#decodetext"><span class="icon icon-link"></span></a><code>decodeText</code></h2><p><strong>Default:</strong> <a href="https://github.com/smikhalevski/speedy-entities#decode"><code>decodeXML</code> <sup>↗</sup></a></p><p>Decode the text content before it is pushed to an MFML AST node. Use this method to decode HTML entities.</p><p>By default, the compiler supports XML entities and numeric character references.</p><pre><code class="language-json">{
  <span class="pl-ent">"en"</span>: {
...
</code></pre><div class="markdown-alert markdown-alert-tip"><p class="markdown-alert-title"><svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>Tip</p><p>Read more about <a href="https://github.com/smikhalevski/speedy-entities#readme">speedy-entities <sup>↗</sup></a>, the fastest XML/HTML entity encoder/decoder in just 13 kB gzipped.</p></div><h2 id="getargumenttstype"><a class="markdown-permalink" href="#getargumenttstype"><span class="icon icon-link"></span></a><code>getArgumentTSType</code></h2><p><strong>Default:</strong> <a href="https://smikhalevski.github.io/mfml/functions/mfml_compiler.getArgumentIntlTSType.html"><code>getIntlArgumentTSType</code> <sup>↗</sup></a></p><p>Returns the TypeScript type for a given argument.</p><pre><code class="language-ts"><span class="pl-k">export</span> <span class="pl-k">default</span> <span class="pl-en">defineConfig</span>({
  messages: {
    en: {
      greeting: <span class="pl-s"><span class="pl-pds">'</span>{name} is {age, number} years old<span class="pl-pds">'</span></span>,
    },
...
</code></pre><p>By default, <a href="https://smikhalevski.github.io/mfml/functions/mfml_compiler.getArgumentIntlTSType.html"><code>getIntlArgumentTSType</code> <sup>↗</sup></a> is used. It returns the TypeScript type of an argument that matches the requirements of <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl"><code>Intl</code> <sup>↗</sup></a> formats.</p><table><thead><tr><th align="left">Argument type</th><th align="left">TypeScript type</th></tr></thead><tbody><tr><td align="left"><code>number</code></td><td align="left"><code>number | bigint</code></td></tr><tr><td align="left"><code>date</code></td><td align="left"><code>number | Date</code></td></tr><tr><td align="left"><code>time</code></td><td align="left"><code>number | Date</code></td></tr><tr><td align="left"><code>list</code></td><td align="left"><code>string[]</code></td></tr><tr><td align="left"><code>plural</code></td><td align="left"><code>number</code></td></tr><tr><td align="left"><code>selectOrdinal</code></td><td align="left"><code>number</code></td></tr><tr><td align="left"><code>select</code></td><td align="left">A union of category name literals and <code>string &#x26; {}</code> for the "other" category.</td></tr></tbody></table><h2 id="tokenizeroptions"><a class="markdown-permalink" href="#tokenizeroptions"><span class="icon icon-link"></span></a><code>tokenizerOptions</code></h2><p><strong>Default:</strong> <a href="https://smikhalevski.github.io/mfml/variables/mfml_parser.htmlTokenizerOptions.html"><code>htmlTokenizerOptions</code> <sup>↗</sup></a></p><p>Options that define how MFML messages are tokenized. By default, forgiving HTML tokenizer options are used.</p><pre><code class="language-ts"><span class="pl-k">export</span> <span class="pl-k">default</span> <span class="pl-en">defineConfig</span>({
  messages: {
    en: {
...
</code></pre><p>The compiled message would be:</p><!-- prettier-ignore --><pre><code class="language-html">&#x3C;<span class="pl-ent">h1</span>>Hello&#x3C;/<span class="pl-ent">h1</span>>&#x3C;<span class="pl-ent">p</span>>Dear diary&#x3C;/<span class="pl-ent">p</span>>
...
</code></pre><p>The callback is called with the following arguments:</p><table><thead><tr><th align="left"><code>token</code></th><th align="right"><code>startIndex</code></th><th align="right"><code>endIndex</code></th><th align="left">Substring</th></tr></thead><tbody><tr><td align="left"><code>'TEXT'</code></td><td align="right">0</td><td align="right">7</td><td align="left"><code>'Hello, '</code></td></tr><tr><td align="left"><code>'START_TAG_NAME'</code></td><td align="right">8</td><td align="right">9</td><td align="left"><code>'b'</code></td></tr><tr><td align="left"><code>'START_TAG_CLOSING'</code></td><td align="right">9</td><td align="right">10</td><td align="left"><code>'>'</code></td></tr><tr><td align="left"><code>'ARGUMENT_NAME'</code></td><td align="right">11</td><td align="right">15</td><td align="left"><code>'name'</code></td></tr><tr><td align="left"><code>'ARGUMENT_CLOSING'</code></td><td align="right">15</td><td align="right">16</td><td align="left"><code>'}'</code></td></tr><tr><td align="left"><code>'END_TAG_NAME'</code></td><td align="right">18</td><td align="right">19</td><td align="left"><code>'b'</code></td></tr><tr><td align="left"><code>'TEXT'</code></td><td align="right">20</td><td align="right">21</td><td align="left"><code>'!'</code></td></tr></tbody></table><p>Tokens are <em>guaranteed</em> to be returned in correct order or a <a href="https://smikhalevski.github.io/mfml/classes/mfml_parser.ParserError.html"><code>ParserError</code> <sup>↗</sup></a> is thrown. Missing tokens can be inserted to restore the correct order if needed, depending on provided tokenizer option.</p><p>Create a tokenizer with a custom set of options:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">tokenizer</span> <span class="pl-k">=</span> <span class="pl-en">createTokenizer</span>({
  isUnbalancedStartTagsImplicitlyClosed: <span class="pl-c1">true</span>,
});
</code></pre><p>MFML provides a preconfigured forgiving HTML tokenizer <a href="https://smikhalevski.github.io/mfml/variables/mfml_parser.htmlTokenizer.html"><code>htmlTokenizer</code> <sup>↗</sup></a> and corresponding set of options <a href="https://smikhalevski.github.io/mfml/variables/mfml_parser.htmlTokenizerOptions.html"><code>htmlTokenizerOptions</code> <sup>↗</sup></a>:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">createTokenizer</span>, <span class="pl-smi">htmlTokenizerOptions</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml/parser<span class="pl-pds">'</span></span>;
...
</code></pre><p>See <a href="https://www.w3.org/TR/2010/WD-html5-20101019/syntax.html#void-elements">HTML5 Void Elements</a> for more info.</p><h2 id="rawtexttags"><a class="markdown-permalink" href="#rawtexttags"><span class="icon icon-link"></span></a><code>rawTextTags</code></h2><p><strong>Default:</strong> <code>[]</code></p><p>The list of tags which content is interpreted as plain text. Tags inside raw text tag are treated as plain text.</p><pre><code class="language-ts"><span class="pl-en">createTokenizer</span>({
...
</code></pre><p>See <a href="https://www.w3.org/TR/2010/WD-html5-20101019/syntax.html#raw-text-elements">HTML5 Raw Text Elements</a> for more info.</p><h2 id="implicitlyclosedtags"><a class="markdown-permalink" href="#implicitlyclosedtags"><span class="icon icon-link"></span></a><code>implicitlyClosedTags</code></h2><p><strong>Default:</strong> <code>{}</code></p><p>The map from a tag to a list of tags that must be closed if it is opened.</p><p>For example, in HTML <code>p</code> and <code>h1</code> tags have the following semantics:</p><!-- prettier-ignore --><pre><code class="language-html">&#x3C;<span class="pl-ent">p</span>>&#x3C;<span class="pl-ent">h1</span>>&#x3C;/<span class="pl-ent">h1</span>> ⮕ &#x3C;<span class="pl-ent">p</span>>&#x3C;/<span class="pl-ent">p</span>>&#x3C;<span class="pl-ent">h1</span>>&#x3C;/<span class="pl-ent">h1</span>>
                   ^^^
...
</code></pre><p>Use in conjunctions with <a href="#isunbalancedstarttagsimplicitlyclosed"><code>isUnbalancedStartTags​ImplicitlyClosed</code></a>.</p><h2 id="implicitlyopenedtags"><a class="markdown-permalink" href="#implicitlyopenedtags"><span class="icon icon-link"></span></a><code>implicitlyOpenedTags</code></h2><p><strong>Default:</strong> <code>[]</code></p><p>The list of tags for which a start tag is inserted if an unbalanced end tag is met. Otherwise, a <a href="https://smikhalevski.github.io/mfml/classes/mfml_parser.ParserError.html"><code>ParserError</code> <sup>↗</sup></a> is thrown.</p><p>You can ignore unbalanced end tags with <a href="#isunbalancedendtagsignored"><code>isUnbalancedEndTagsIgnored</code></a>.</p><p>For example, in HTML <code>p</code> tag follow this semantics:</p><pre><code class="language-html">&#x3C;/<span class="pl-ent">p</span>>  ⮕ &#x3C;<span class="pl-ent">p</span>>&#x3C;/<span class="pl-ent">p</span>>
            ^^^
</code></pre><p>To achieve this behavior, set this option to:</p><pre><code class="language-ts"><span class="pl-en">createTokenizer</span>({
  implicitlyOpenedTags: [<span class="pl-s"><span class="pl-pds">'</span>p<span class="pl-pds">'</span></span>],
});
</code></pre><h2 id="iscaseinsensitivetags"><a class="markdown-permalink" href="#iscaseinsensitivetags"><span class="icon icon-link"></span></a><code>isCaseInsensitive​Tags</code></h2><p><strong>Default:</strong> <code>false</code></p><p>If <code>true</code> then [A-Z] characters are case-insensitive in tag names.</p><!-- prettier-ignore --><pre><code class="language-html">&#x3C;<span class="pl-ent">em</span>>&#x3C;/<span class="pl-ent">EM</span>> ⮕ &#x3C;<span class="pl-ent">em</span>>&#x3C;/<span class="pl-ent">em</span>>
                  ^^^
</code></pre><h2 id="isselfclosingtagsrecognized"><a class="markdown-permalink" href="#isselfclosingtagsrecognized"><span class="icon icon-link"></span></a><code>isSelfClosingTags​Recognized</code></h2><p><strong>Default:</strong> <code>false</code></p><p>If <code>true</code> then self-closing tags are recognized, otherwise they are treated as start tags.</p><!-- prettier-ignore --><pre><code class="language-html">&#x3C;<span class="pl-ent">link</span> />
      ^
</code></pre><h2 id="isunbalancedstarttagsimplicitlyclosed"><a class="markdown-permalink" href="#isunbalancedstarttagsimplicitlyclosed"><span class="icon icon-link"></span></a><code>isUnbalancedStart​Tags​Implicitly​Closed</code></h2><p><strong>Default:</strong> <code>false</code></p><p>If <code>true</code> then unbalanced start tags are forcefully closed. Otherwise, a <a href="https://smikhalevski.github.io/mfml/classes/mfml_parser.ParserError.html"><code>ParserError</code> <sup>↗</sup></a> is thrown.</p><pre><code class="language-html">&#x3C;<span class="pl-ent">a</span>>&#x3C;<span class="pl-ent">b</span>>&#x3C;/<span class="pl-ent">a</span>> ⮕ &#x3C;<span class="pl-ent">a</span>>&#x3C;<span class="pl-ent">b</span>>&#x3C;/<span class="pl-ent">b</span>>&#x3C;/<span class="pl-ent">a</span>>
                    ^^^
</code></pre><p>Use in conjunctions with <a href="#isunbalancedendtagsignored"><code>isUnbalancedEndTagsIgnored</code></a>.</p><h2 id="isunbalancedendtagsignored"><a class="markdown-permalink" href="#isunbalancedendtagsignored"><span class="icon icon-link"></span></a><code>isUnbalancedEndTags​Ignored</code></h2><p><strong>Default:</strong> <code>false</code></p><p>If <code>true</code> then end tags that don't have a corresponding start tag are ignored. Otherwise, a <a href="https://smikhalevski.github.io/mfml/classes/mfml_parser.ParserError.html"><code>ParserError</code> <sup>↗</sup></a> is thrown.</p><pre><code class="language-html">&#x3C;<span class="pl-ent">a</span>>&#x3C;/<span class="pl-ent">b</span>>&#x3C;/<span class="pl-ent">a</span>> ⮕ &#x3C;<span class="pl-ent">a</span>>&#x3C;/<span class="pl-ent">a</span>>
    ^^^
</code></pre><p>Use in conjunctions with <a href="#isunbalancedstarttagsimplicitlyclosed"><code>isUnbalancedStartTagsImplicitlyClosed</code></a>.</p><h2 id="israwtextinterpolated"><a class="markdown-permalink" href="#israwtextinterpolated"><span class="icon icon-link"></span></a><code>isRawText​Interpolated</code></h2><p><strong>Default:</strong> <code>false</code></p><p>If <code>true</code> then arguments are parsed inside <a href="#rawtexttags"><code>rawTextTags</code></a>.</p><p>Here's how to add a raw text tag:</p><pre><code class="language-ts"><span class="pl-en">createTokenizer</span>({
...
</code></pre><p>An argument inside the <code>&#x3C;plaintext></code> tag is interpolated:</p><!-- prettier-ignore --><pre><code class="language-html">&#x3C;<span class="pl-ent">plaintext</span>>{name}&#x3C;/<span class="pl-ent">plaintext</span>>
           ^^^^^^
</code></pre><h2 id="isoctothorperecognized"><a class="markdown-permalink" href="#isoctothorperecognized"><span class="icon icon-link"></span></a><code>isOctothorpe​Recognized</code></h2><p><strong>Default:</strong> <code>false</code></p><p>If <code>true</code> then an octothorpe character ("#") inside an argument category is replaced with the argument value.</p><pre><code>{gender, select, male { He is a # } female { She is a # }}
                                                      ^
</code></pre><h1 id="parsing-messages"><a class="markdown-permalink" href="#parsing-messages"><span class="icon icon-link"></span></a>Parsing messages</h1><p>Create a parser using <a href="https://smikhalevski.github.io/mfml/functions/mfml_parser.createParser.html"><code>createParser</code> <sup>↗</sup></a>:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">createParser</span>, <span class="pl-smi">htmlTokenizer</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml/parser<span class="pl-pds">'</span></span>;
...
</code></pre><p>This returns a <a href="https://smikhalevski.github.io/mfml/interfaces/mfml.MessageNode.html"><code>MessageNode</code> <sup>↗</sup></a> instance that looks like this:</p><!-- prettier-ignore --><pre><code class="language-json5">{
...
</code></pre><p>Use <a href="https://smikhalevski.github.io/mfml/functions/mfml.walkNode.html"><code>walkNode</code> <sup>↗</sup></a> to traverse AST:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">walkNode</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml<span class="pl-pds">'</span></span>;
...
</code></pre><h1 id="motivation"><a class="markdown-permalink" href="#motivation"><span class="icon icon-link"></span></a>Motivation</h1><p>Splitting the app code into chunks and loading those chunks at runtime is usually handled by a bundler. Modern i18n tools, such as <code>i18next</code>, rely on JSON files that are baked into an application bundle or loaded asynchronously. This approach has several downsides:</p><ul><li>You have to somehow split your translations into separate JSON files before bundling. Otherwise, your clients would have to download all translations at application start;</li><li>You have to load translations manually when they are needed;</li><li>Non-used translations are still bundled and loaded unless you manually delete them;</li><li>Errors, such as missed interpolation parameters and illegal parameter types, are thrown at runtime.</li></ul><p>All the above is highly error-prone due to the human factor.</p><p>MFML compiles translations into message functions that you can import as a module into your code. This approach provides multiple benefits:</p><ul><li>Message functions are bundled and loaded along with your code. So you don't have to manage the translation loading process manually;</li><li>Message functions are tree-shakeable, so chunks assembled by a bundler would contain only used translations;</li><li>Message functions can be type-checked at compile time. So you won't forget that translation required a parameter, or a parameter must be of a particular type. Change in the translation key would require changes in modules that import a corresponding message function. Otherwise, a type checker, or a bundler would signal you that the imported function is missing;</li><li>Message functions use a runtime to render the translation. Runtimes can produce React elements, plain strings, or any other output you need.</li></ul>`};function m(){return s.createElement(e,{logo:s.createElement("div",{style:{...l(p,a),width:"25rem"},className:n.Logo,title:"MFML"}),readme:c})}export{m as default};
