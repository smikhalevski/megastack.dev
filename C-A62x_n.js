...
<span class="pl-k">export</span> <span class="pl-k">const</span> <span class="pl-en">App</span> <span class="pl-k">=</span> () <span class="pl-k">=></span> (
  ...
  other { # messages }
                 ...
                 ^^^^^^
                            ...
                            ^^^^^^^
</code></pre><p>Default configuration provides following argument types and styles:</p><table><tbody><tr><th align="left">Argument\xA0type</th><th align="left">Argument\xA0style</th><th align="left">Example,\xA0<code>en</code>\xA0locale</th><th align="left">Required\xA0value\xA0type</th></tr><tr><td valign="top" rowspan="5"><code>number</code></td><td>—</td><td>1,000.99</td><td valign="top" rowspan="5"><code>number</code> or <code>bigint</code></td></tr><tr><td><code>decimal</code></td><td>1,000.99</td></tr><tr><td><code>integer</code></td><td>1,000</td></tr><tr><td><code>percent</code></td><td>75%</td></tr><tr><td><code>currency</code></td><td>$1,000.00</td></tr><tr><td valign="top" rowspan="5"><code>date</code></td><td>—</td><td>1/1/1970</td><td valign="top" rowspan="5"><code>number</code> or <code>Date</code></td></tr><tr><td><code>short</code></td><td>1/1/70</td></tr><tr><td><code>medium</code></td><td>Jan 1, 1970</td></tr><tr><td><code>long</code></td><td>January 1, 1970</td></tr><tr><td><code>full</code></td><td>Thursday, January 1, 1970</td></tr><tr><td valign="top" rowspan="5"><code>time</code></td><td>—</td><td>12:00\xA0AM</td><td valign="top" rowspan="5"><code>number</code> or <code>Date</code></td></tr><tr><td><code>short</code></td><td>12:00\xA0AM</td></tr><tr><td><code>medium</code></td><td>12:00:00\xA0AM</td></tr><tr><td><code>long</code></td><td>12:00:00\xA0AM\xA0UTC</td></tr><tr><td><code>full</code></td><td>12:00:00\xA0AM\xA0Coordinated\xA0Universal\xA0Time</td></tr><tr><td valign="top" rowspan="4"><code>conjunction</code></td><td>—</td><td>A, B, and C</td><td valign="top" rowspan="4"><code>string[]</code></td></tr><tr><td><code>narrow</code></td><td>A, B, C</td></tr><tr><td><code>short</code></td><td>A, B, &#x26; C</td></tr><tr><td><code>long</code></td><td>A, B, and C</td></tr><tr><td valign="top" rowspan="4"><code>disjunction</code></td><td>—</td><td>A, B, or C</td><td valign="top" rowspan="4"><code>string[]</code></td></tr><tr><td><code>narrow</code></td><td>A, B, or C</td></tr><tr><td><code>short</code></td><td>A, B, or C</td></tr><tr><td><code>long</code></td><td>A, B, or C</td></tr></tbody></table><h2 id="options"><a class="markdown-permalink" href="#options"><span class="icon icon-link"></span></a>Options</h2><p>Instead of using a predefined style, you can provide a set of options for a formatter:</p><pre><code>{propertyArea, number,
  style=unit
  unit=acre
  unitDisplay=long
}
...
</code></pre><p>Now, lets create a string renderer that uses this formatter:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">defaultArgumentFormatter</span>, <span class="pl-smi">defaultCategorySelector</span>, <span class="pl-k">type</span> <span class="pl-smi">Renderer</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml<span class="pl-pds">'</span></span>;
...
<span class="pl-k">const</span> <span class="pl-c1">myRenderer</span><span class="pl-k">:</span> <span class="pl-en">Renderer</span>&#x3C;<span class="pl-c1">string</span>> <span class="pl-k">=</span> {
  ...
  <span class="pl-c">// 🟡 Pass a custom formatter</span>
  ...
  <span class="pl-c">// 🟡 Pass a custom renderer</span>
  renderer: <span class="pl-smi">myRenderer</span>,
});
...
</code></pre><p><a href="https://smikhalevski.github.io/mfml/functions/mfml.combineArgumentFormatters.html"><code>combineArgumentFormatters</code><span class="external"></span></a> creates an argument formatter that sequentially applies each formatter from the list of formatters until one returns a formatted value. If none of the formatters returns a formatted value, then a value returned as-is.</p><p>Or you can fallback to a default formatter:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">combineArgumentFormatters</span>, <span class="pl-smi">defaultArgumentFormatter</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml<span class="pl-pds">'</span></span>;
