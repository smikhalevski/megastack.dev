import{a as e}from"./CZfrytea.js";import{C as t}from"./DnPjV-FA.js";import{n,t as r}from"./Bt_cw3QX.js";import{n as i,t as a}from"./AHr_qpGY.js";import{n as o}from"./x00wL2_4.js";var s=e(t(),1),c={version:`0.0.28`,tocContent:`<p><span class="toc-icon">🔰 </span><a href="#introduction"><strong>Introduction</strong></a></p><ul><li><a href="#executor-keys">Executor keys</a></li><li><a href="#execute-a-task">Execute a task</a></li><li><a href="#abort-a-task">Abort a task</a></li><li><a href="#replace-a-task">Replace a task</a></li><li><a href="#wait-for-a-task-to-complete">Wait for a task to complete</a></li><li><a href="#retry-the-latest-task">Retry the latest task</a></li><li><a href="#settle-an-executor">Settle an executor</a></li><li><a href="#clear-an-executor">Clear an executor</a></li><li><a href="#optimistic-updates">Optimistic updates</a></li></ul><p><span class="toc-icon">📢 </span><a href="#events-and-lifecycle"><strong>Events and lifecycle</strong></a></p><ul><li><a href="#activate-an-executor">Activate an executor</a></li><li><a href="#invalidate-results">Invalidate results</a></li><li><a href="#detach-an-executor">Detach an executor</a></li></ul><p><span class="toc-icon">🔌 </span><a href="#plugins"><strong>Plugins</strong></a></p><ul><li><a href="#abortdeactivated"><code>abortDeactivated</code></a></li><li><a href="#abortpendingafter"><code>abortPendingAfter</code></a></li><li><a href="#abortwhen"><code>abortWhen</code></a></li><li><a href="#detachdeactivated"><code>detachDeactivated</code></a></li><li><a href="#detachinactive"><code>detachInactive</code></a></li><li><a href="#invalidateafter"><code>invalidateAfter</code></a></li><li><a href="#invalidatebypeers"><code>invalidateByPeers</code></a></li><li><a href="#invalidatepeers"><code>invalidatePeers</code></a></li><li><a href="#invalidatewhen"><code>invalidateWhen</code></a></li><li><a href="#lazytask"><code>lazyTask</code></a></li><li><a href="#rejectpendingafter"><code>rejectPendingAfter</code></a></li><li><a href="#resolveby"><code>resolveBy</code></a></li><li><a href="#retryactivated"><code>retryActivated</code></a></li><li><a href="#retryfulfilled"><code>retryFulfilled</code></a></li><li><a href="#retryinvalidated"><code>retryInvalidated</code></a></li><li><a href="#retryrejected"><code>retryRejected</code></a></li><li><a href="#retrywhen"><code>retryWhen</code></a></li><li><a href="#syncbrowserstorage"><code>syncBrowserStorage</code></a></li><li><a href="#syncexternalstore"><code>syncExternalStore</code></a></li></ul><p><span class="toc-icon">👁️ </span><a href="#observables"><strong>Observables</strong></a></p><ul><li><a href="#navigatoronline"><code>navigatorOnline</code></a></li><li><a href="#navigatoroffline"><code>navigatorOffline</code></a></li><li><a href="#windowfocused"><code>windowFocused</code></a></li><li><a href="#windowblurred"><code>windowBlurred</code></a></li></ul><p><span class="toc-icon">⚛️ </span><a href="#react-integration"><strong>React integration</strong></a></p><ul><li><a href="#suspense">Suspense</a></li><li><a href="#external-executors">External executors</a></li></ul><p><span class="toc-icon">🚀 </span><a href="#server-side-rendering"><strong>Server-side rendering</strong></a></p><ul><li><a href="#render-to-string">Render to string</a></li><li><a href="#streaming-ssr">Streaming SSR</a></li><li><a href="#state-serialization">State serialization</a></li><li><a href="#content-security-policy-support">Content-Security-Policy support</a></li><li><a href="#nextjs-integration">Next.js integration</a></li></ul><p><span class="toc-icon">⚙️ </span><a href="#devtools"><strong>Devtools</strong></a></p><p><span class="toc-icon">🍪 </span><strong>Cookbook</strong></p><ul><li><a href="#dependent-tasks">Dependent tasks</a></li><li><a href="#derived-executors">Derived executors</a></li><li><a href="#pagination">Pagination</a></li><li><a href="#infinite-scroll">Infinite scroll</a></li><li><a href="#invalidate-all-executors">Invalidate all executors</a></li><li><a href="#prefetching">Prefetching</a></li><li><a href="#storage-state-versioning">Storage state versioning</a></li><li><a href="#global-loading-indicator">Global loading indicator</a></li></ul><p><span class="toc-icon">🔎 </span><strong>Resources</strong></p><ul><li><a href="https://smikhalevski.github.io/react-executor/">API docs<span class="external"></span></a></li><li><a href="https://stackblitz.com/edit/react-executor-todo-app?file=README.md">TODO app example<span class="external"></span></a></li><li><a href="https://codesandbox.io/p/devbox/react-executor-ssr-streaming-example-mwrmrs">Streaming SSR example<span class="external"></span></a></li><li><a href="https://codesandbox.io/p/devbox/react-executor-next-example-whsj4v">Next.js integration example<span class="external"></span></a></li><li><a href="https://github.com/smikhalevski/react-executor#readme">GitHub<span class="external"></span></a></li><li><a href="/react-executor.md">View as Markdown</a></li></ul>`,articleContent:`<p>Asynchronous task execution and state management for React.</p><ul><li>TypeScript first.</li><li>Expressive and concise API with strict typings.</li><li>Works great with SSR and Suspense.</li><li><a href="#plugins">Extensible with plugins.</a></li><li><a href="#devtools">First class devtools.</a></li><li><a href="https://bundlephobia.com/package/react-executor">Just 3 kB gzipped.<span class="external"></span></a></li><li>Check out the <a href="#cookbook">Cookbook</a> for real-life examples!</li></ul><br><pre><code class="language-sh">npm install --save-prod react-executor
</code></pre><br><h1 id="introduction"><a class="markdown-permalink" href="#introduction"><span class="icon icon-link"></span></a>Introduction</h1><p>An executor runs a task, stores the execution result, and provides access to that result. Tasks are callbacks that return a value or throw an error.</p><p>An <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html"><code>Executor</code><span class="external"></span></a> is created and managed by an <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html"><code>ExecutorManager</code><span class="external"></span></a>, which controls the executor's lifecycle:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">ExecutorManager</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
</code></pre><p>Each executor has a unique key within the manager's scope. In this example, we created a new executor with the key <code>'rooky'</code>. The manager creates a new executor when you call <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html#getorcreate"><code>getOrCreate</code><span class="external"></span></a> with a previously unused key. Subsequent calls with the same key return the same executor instance.</p><p>If you want to retrieve an existing executor by its key and avoid creating a new one if it doesn't exist, use <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html#get"><code>get</code><span class="external"></span></a>:</p><pre><code class="language-ts"><span class="pl-smi">manager</span>.<span class="pl-c1">get</span>(<span class="pl-s"><span class="pl-pds">'</span>bobby<span class="pl-pds">'</span></span>);
...
<span class="pl-c">// ⮕ Executor&#x3C;any></span>
</code></pre><p>The executor we created is <em>unsettled</em>, meaning it stores neither a value nor a failure reason:</p><pre><code class="language-ts"><span class="pl-smi">rookyExecutor</span>.<span class="pl-smi">isSettled</span>;
...
</code></pre><p>An initial value may be a task (which will be executed), a promise (which the executor will await), or any other value that immediately fulfills the executor. Read more in the <a href="#execute-a-task">Execute a task</a> and in the <a href="#settle-an-executor">Settle an executor</a> sections.</p><p>When creating an executor, you can also provide an array of plugins:</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">retryRejected</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/retryRejected<span class="pl-pds">'</span></span>;
...
</code></pre><p>Plugins can subscribe to <a href="#events-and-lifecycle">executor events</a> or modify the executor instance. Read more about plugins in the <a href="#plugins">Plugins</a> section.</p><h2 id="executor-keys"><a class="markdown-permalink" href="#executor-keys"><span class="icon icon-link"></span></a>Executor keys</h2><p>Anything can be an executor key: a string, a number, an object, etc. By default, keys are considered identical if their <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON"><code>JSON</code><span class="external"></span></a>-serialized form is identical:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">manager</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">ExecutorManager</span>();
...
</code></pre><h2 id="execute-a-task"><a class="markdown-permalink" href="#execute-a-task"><span class="icon icon-link"></span></a>Execute a task</h2><p>Let's execute a new task:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">ExecutorManager</span>, <span class="pl-smi">ExecutorTaskCallback</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;

<span class="pl-k">const</span> <span class="pl-c1">manager</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">ExecutorManager</span>();

<span class="pl-k">const</span> <span class="pl-c1">rookyExecutor</span> <span class="pl-k">=</span> <span class="pl-smi">manager</span>.<span class="pl-en">getOrCreate</span>(<span class="pl-s"><span class="pl-pds">'</span>rooky<span class="pl-pds">'</span></span>);

<span class="pl-k">const</span> <span class="pl-en">helloTask</span><span class="pl-k">:</span> <span class="pl-en">ExecutorTaskCallback</span> <span class="pl-k">=</span> <span class="pl-k">async</span> (<span class="pl-v">signal</span>, <span class="pl-v">executor</span>) <span class="pl-k">=></span> <span class="pl-s"><span class="pl-pds">'</span>Hello<span class="pl-pds">'</span></span>;
...
</code></pre><p><code>helloTask</code> receives an <a href="https://developer.mozilla.org/en-US/docs/Web/API/AbortSignal"><code>AbortSignal</code><span class="external"></span></a> and <code>rookyExecutor</code> as arguments. The signal is aborted if the task is <a href="#abort-a-task">aborted</a> or <a href="#replace-a-task">replaced</a>.</p><p>While tasks can be synchronous or asynchronous, executors always handle them in an asynchronous fashion. The executor is marked as <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#ispending">pending<span class="external"></span></a> immediately after <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#execute"><code>execute</code><span class="external"></span></a> is called:</p><pre><code class="language-ts"><span class="pl-c">// The executor is waiting for the task to complete</span>
...
</code></pre><p>The executor keeps track of the <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#task">latest task<span class="external"></span></a> it has executed:</p><pre><code class="language-ts"><span class="pl-smi">rookyExecutor</span>.<span class="pl-smi">task</span>;
...
</code></pre><p>Executors always preserve the latest value and the latest reason. So even when the executor <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#ispending"><code>isPending</code><span class="external"></span></a>, you can access the previous value or failure reason. Use <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#isfulfilled"><code>isFulfilled</code><span class="external"></span></a> and <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#isrejected"><code>isRejected</code><span class="external"></span></a> to detect with what result the executor has settled the last time. An executor cannot be both fulfilled and rejected at the same time.</p><pre><code class="language-ts"><span class="pl-c">// Execute a new task</span>
...
</code></pre><h2 id="abort-a-task"><a class="markdown-permalink" href="#abort-a-task"><span class="icon icon-link"></span></a>Abort a task</h2><p>The promise returned by the <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#execute"><code>execute</code><span class="external"></span></a> method is <a href="https://smikhalevski.github.io/parallel-universe/classes/AbortablePromise.html">abortable<span class="external"></span></a> so the task can be prematurely aborted. Results of the aborted task are discarded:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">helloPromise</span> <span class="pl-k">=</span> <span class="pl-smi">rookyExecutor</span>.<span class="pl-en">execute</span>(<span class="pl-k">async</span> () <span class="pl-k">=></span> <span class="pl-s"><span class="pl-pds">'</span>Hello<span class="pl-pds">'</span></span>);
...
</code></pre><p>If there's no pending task, then aborting an executor is a no-op.</p><p>When a task is aborted, the signal it received as an argument is aborted as well. Check the <a href="https://developer.mozilla.org/en-US/docs/Web/API/AbortSignal/aborted">signal status<span class="external"></span></a> to ensure that computation should be concluded.</p><p>For example, if you're fetching data from the server inside a task, you can pass signal as a <a href="https://developer.mozilla.org/en-US/docs/Web/API/fetch#signal"><code>fetch</code><span class="external"></span></a> option:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-en">byeTask</span><span class="pl-k">:</span> <span class="pl-en">ExecutorTaskCallback</span> <span class="pl-k">=</span> <span class="pl-k">async</span> (<span class="pl-v">signal</span>, <span class="pl-v">executor</span>) <span class="pl-k">=></span> {
...
</code></pre><h2 id="retry-the-latest-task"><a class="markdown-permalink" href="#retry-the-latest-task"><span class="icon icon-link"></span></a>Retry the latest task</h2><p>To retry the <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#task">latest task<span class="external"></span></a>, use <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#retry"><code>retry</code><span class="external"></span></a>:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">planets</span> <span class="pl-k">=</span> [<span class="pl-s"><span class="pl-pds">'</span>Mars<span class="pl-pds">'</span></span>, <span class="pl-s"><span class="pl-pds">'</span>Venus<span class="pl-pds">'</span></span>];
...
<span class="pl-smi">executor</span>.<span class="pl-en">retry</span>();
</code></pre><h2 id="settle-an-executor"><a class="markdown-permalink" href="#settle-an-executor"><span class="icon icon-link"></span></a>Settle an executor</h2><p>While tasks are always handled in an asynchronous fashion, there are cases when an executor should be settled synchronously.</p><p>Executor can be synchronously fulfilled via <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#resolve"><code>resolve</code><span class="external"></span></a>:</p><pre><code class="language-ts"><span class="pl-smi">executor</span>.<span class="pl-c1">resolve</span>(<span class="pl-s"><span class="pl-pds">'</span>Venus<span class="pl-pds">'</span></span>);
...
<span class="pl-smi">executor</span>.<span class="pl-c1">value</span>;
<span class="pl-c">// ⮕ 'Venus'</span>
</code></pre><p>Or rejected via <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#reject"><code>reject</code><span class="external"></span></a>:</p><pre><code class="language-ts"><span class="pl-smi">executor</span>.<span class="pl-c1">reject</span>(<span class="pl-k">new</span> <span class="pl-c1">Error</span>(<span class="pl-s"><span class="pl-pds">'</span>Ooops!<span class="pl-pds">'</span></span>));
...
<span class="pl-smi">executor</span>.<span class="pl-c1">value</span>;
<span class="pl-c">// ⮕ 'Mars'</span>
</code></pre><h2 id="clear-an-executor"><a class="markdown-permalink" href="#clear-an-executor"><span class="icon icon-link"></span></a>Clear an executor</h2><p>After the executor becomes <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#issettled">settled<span class="external"></span></a>, it remains settled until it is cleared.</p><p>You can reset the executor back to its unsettled state using <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#clear"><code>clear</code><span class="external"></span></a>:</p><pre><code class="language-ts"><span class="pl-smi">executor</span>.<span class="pl-c1">clear</span>();
</code></pre><p>Clearing an executor removes the stored value and reason, but <em>doesn't</em> affect the pending task execution and preserves the <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#task">latest task<span class="external"></span></a> that was executed.</p><h2 id="optimistic-updates"><a class="markdown-permalink" href="#optimistic-updates"><span class="icon icon-link"></span></a>Optimistic updates</h2><p>Optimistic updates are a UX technique where the UI reflects the result of an action instantly, before the server has confirmed it. If the server succeeds, nothing changes visually. If the server fails, the UI rolls back to the state it was in before the action.</p><p>In React Executor, optimistic updates are first-class citizens and can be achieved by providing <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.ExecutorTask.html#pendingxalue"><code>pendingValue</code><span class="external"></span></a> in executor task. When a task is submitted with a <code>pendingValue</code>, the executor resolves to that value instantly (before the task callback runs) and stores a checkpoint of the previous state. If the task fails, the checkpoint is restored automatically.</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>meaningOfLife<span class="pl-pds">'</span></span>);

<span class="pl-k">const</span> <span class="pl-en">handleClick</span> <span class="pl-k">=</span> () <span class="pl-k">=></span> {
  <span class="pl-smi">executor</span>.<span class="pl-en">execute</span>({
    <span class="pl-en">callback</span>: <span class="pl-k">async</span> <span class="pl-v">signal</span> <span class="pl-k">=></span> <span class="pl-k">await</span> <span class="pl-en">getTheMeaningOfLife</span>(<span class="pl-smi">signal</span>),

    <span class="pl-c">// 🟡 Executor is resolved with this value before running callback</span>
    pendingValue: <span class="pl-c1">42</span>,
  });
};
</code></pre><p>The UI reflects <code>42</code> the moment the button is clicked. If <code>getTheMeaningOfLife</code> rejects, the executor rolls back to the value it held before execute was called — no manual snapshot or error handling required.</p><p>The rollback covers three cases depending on what state the executor was in before the optimistic update was applied:</p><ul><li><p>If previously <em>fulfilled</em>, then the executor is resolved back to the previous value.</p></li><li><p>If previously <em>rejected</em>, then the executor is rejected with the previous reason.</p></li><li><p>If previously <em>unsettled</em>, then the executor is cleared back to its initial state.</p></li></ul><p>This means <code>pendingValue</code> is safe to use regardless of whether the executor has ever successfully fetched data.</p><h1 id="events-and-lifecycle"><a class="markdown-permalink" href="#events-and-lifecycle"><span class="icon icon-link"></span></a>Events and lifecycle</h1><p>Executors publish various events when their state changes. To subscribe to executor events use the <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#subscribe"><code>subscribe</code><span class="external"></span></a> method:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">manager</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">ExecutorManager</span>();
...
</code></pre><p>Both executors and managers may have multiple subscribers and each subscriber receives <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.ExecutorEvent.html">events<span class="external"></span></a> with following types:</p><dl><dt>attached</dt><dd><p>The executor was just created, plugins were applied to it, and it was attached to the manager. Read more about plugins in the <a href="#plugins">Plugins</a> section.</p></dd><dt>detached</dt><dd><p>The executor was just detached: it was removed from the manager and all of its subscribers were unsubscribed. Read more in the <a href="#detach-an-executor">Detach an executor</a> section.</p></dd><dt>activated</dt><dd><p>The executor was inactive and became active. This means that there are consumers that observe the state of the executor. Read more in the <a href="#activate-an-executor">Activate an executor</a> section.</p></dd><dt>deactivated</dt><dd><p>The executor was active and became inactive. This means that there are no consumers that observe the state of the executor. Read more in the <a href="#activate-an-executor">Activate an executor</a> section.</p></dd><dt>pending</dt><dd><p>The executor started <a href="#execute-a-task">a task execution</a>. You can find the latest task the executor handled in the <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#task"><code>Executor.task</code><span class="external"></span></a> property.</p></dd><dt>fulfilled</dt><dd><p>The executor was fulfilled with a value.</p></dd><dt>rejected</dt><dd><p>The executor was rejected with a reason.</p></dd><dt>aborted</dt><dd><p>The <a href="#abort-a-task">task was aborted</a>.</p><p>If executor is still <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#ispending">pending<span class="external"></span></a> when an <code>'aborted'</code> event is published then the currently pending task is being <a href="#replace-a-task">replaced</a> with a new task.</p><p>Calling <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#execute"><code>Executor.execute</code><span class="external"></span></a> when handling an abort event may lead to stack overflow. If you need to do this anyway, execute a new task from async context using <a href="https://developer.mozilla.org/en-US/docs/Web/API/queueMicrotask"><code>queueMicrotask</code><span class="external"></span></a> or a similar API.</p></dd><dt>cleared</dt><dd><p>The executor was cleared and now isn't settled.</p></dd><dt>invalidated</dt><dd><p>Results stored in an executor were <a href="#invalidate-results">invalidated</a>.</p></dd><dt>annotated</dt><dd><p><a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#annotations">Annotations<span class="external"></span></a> associated with the executor were patched.</p></dd><dt>plugin_configured</dt><dd><p>The configuration of the plugin associated with the executor was updated.</p></dd></dl><h2 id="activate-an-executor"><a class="markdown-permalink" href="#activate-an-executor"><span class="icon icon-link"></span></a>Activate an executor</h2><p>Executors have an <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#isactive">active<span class="external"></span></a> status that tells whether executor is actively used by a consumer.</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">deactivate</span> <span class="pl-k">=</span> <span class="pl-smi">executor</span>.<span class="pl-en">activate</span>();
...
<span class="pl-smi">executor</span>.<span class="pl-smi">isInvalidated</span>;
<span class="pl-c">// ⮕ false</span>
</code></pre><p>By default, invalidating an executor has no effect except marking it as <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#isinvalidated">invalidated<span class="external"></span></a>.</p><h2 id="detach-an-executor"><a class="markdown-permalink" href="#detach-an-executor"><span class="icon icon-link"></span></a>Detach an executor</h2><p>By default, executors that a manager has created are preserved indefinitely and are always available though <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html#get"><code>get</code><span class="external"></span></a>. This isn't always optimal, and you may want to detach an executor when it isn't needed anymore. Use <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html#detach"><code>detach</code><span class="external"></span></a> in such case:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-smi">manager</span>.<span class="pl-en">getOrCreate</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>);
...
<span class="pl-c">// ⮕ true</span>
  ...
  <span class="pl-smi">executor</span>.<span class="pl-en">subscribe</span>(<span class="pl-v">event</span> <span class="pl-k">=></span> {
    <span class="pl-k">if</span> (<span class="pl-c1">event</span>.<span class="pl-c1">type</span> <span class="pl-k">===</span> <span class="pl-s"><span class="pl-pds">'</span>deactivated<span class="pl-pds">'</span></span>) {
...
</code></pre><p>To apply a plugin, pass it to the <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html#getorcreate"><code>ExecutorManager.getOrCreate</code><span class="external"></span></a> or to the <a href="https://smikhalevski.github.io/react-executor/functions/react-executor.useExecutor.html"><code>useExecutor</code><span class="external"></span></a> hook:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-smi">manager</span>.<span class="pl-en">getOrCreate</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-c1">undefined</span>, [<span class="pl-smi">detachPlugin</span>]);
...
</code></pre><div class="markdown-alert markdown-alert-important"><p class="markdown-alert-title"><svg class="octicon octicon-report mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v9.5A1.75 1.75 0 0 1 14.25 13H8.06l-2.573 2.573A1.458 1.458 0 0 1 3 14.543V13H1.75A1.75 1.75 0 0 1 0 11.25Zm1.75-.25a.25.25 0 0 0-.25.25v9.5c0 .138.112.25.25.25h2a.75.75 0 0 1 .75.75v2.19l2.72-2.72a.749.749 0 0 1 .53-.22h6.5a.25.25 0 0 0 .25-.25v-9.5a.25.25 0 0 0-.25-.25Zm7 2.25v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>Important</p><p>Plugins are applied in array order. When combining plugins that react to the same events, order matters. A good rule of thumb: plugins that <em>read</em> state (e.g. <a href="#syncbrowserstorage"><code>syncBrowserStorage</code></a>) should come before plugins that <em>act</em> on it (e.g. <a href="#invalidateafter"><code>invalidateAfter</code></a>), and cleanup plugins (e.g. <a href="#abortdeactivated"><code>abortDeactivated</code></a>) before lifecycle plugins (e.g. <a href="#detachdeactivated"><code>detachDeactivated</code></a>).</p></div><h2 id="abortdeactivated"><a class="markdown-permalink" href="#abortdeactivated"><span class="icon icon-link"></span></a><code>abortDeactivated</code></h2><p><a href="#abort-a-task">Aborts the pending task</a> after the delay if the executor is deactivated.</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">abortDeactivated</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/abortDeactivated<span class="pl-pds">'</span></span>;
...
<span class="pl-c">// breadExecutor is invalidated</span>
<span class="pl-smi">cheeseExecutor</span>.<span class="pl-c1">resolve</span>(<span class="pl-s"><span class="pl-pds">'</span>Mozzarella<span class="pl-pds">'</span></span>);
</code></pre><h2 id="invalidatewhen"><a class="markdown-permalink" href="#invalidatewhen"><span class="icon icon-link"></span></a><code>invalidateWhen</code></h2><p><a href="#invalidate-results">Invalidates</a> the settled executor result when the <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Observable.html">observable<span class="external"></span></a> emits <code>true</code>.</p><p>For example, if the window was offline for more than 5 seconds, then the executor would be invalidated when the window goes back online:</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">invalidateWhen</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/invalidateWhen<span class="pl-pds">'</span></span>;
...
<span class="pl-k">import</span> <span class="pl-smi">invalidateWhen</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/invalidateWhen<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">navigatorOffline</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/observable/navigatorOffline<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">navigatorOnline</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/observable/navigatorOnline<span class="pl-pds">'</span></span>;
...
<span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-smi">heavyTask</span>, [
  ...
  <span class="pl-c">// Abort the task if the window loses focus for at least 10 seconds</span>
...
</code></pre><h2 id="lazytask"><a class="markdown-permalink" href="#lazytask"><span class="icon icon-link"></span></a><code>lazyTask</code></h2><p>Sets <a href="#execute-a-task">an executor task</a> but doesn't execute it.</p><p>This plugin is useful when you have a static initial value and a task that can update this value later:</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">lazyTask</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/lazyTask<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">retryInvalidated</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/retryInvalidated<span class="pl-pds">'</span></span>;
...
</code></pre><p><code>executor</code> is created with the <code>value</code> set to 42. <code>getTheMeaningOfLife</code> task isn't executed and would be called only if executor is invalidated (thanks to <a href="#retryinvalidated"><code>retryInvalidated</code></a> plugin):</p><pre><code class="language-ts"><span class="pl-smi">executor</span>.<span class="pl-en">invalidate</span>();
</code></pre><h2 id="rejectpendingafter"><a class="markdown-permalink" href="#rejectpendingafter"><span class="icon icon-link"></span></a><code>rejectPendingAfter</code></h2><p><a href="#abort-a-task">Aborts the pending task</a> and <a href="#settle-an-executor">rejects the executor</a> with <a href="https://developer.mozilla.org/en-US/docs/Web/API/DOMException#timeouterror"><code>TimeoutError</code><span class="external"></span></a> if the task execution took longer than the given timeout.</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">rejectPendingAfter</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/rejectPendingAfter<span class="pl-pds">'</span></span>;

<span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-smi">heavyTask</span>, [
  <span class="pl-en">rejectPendingAfter</span>(<span class="pl-c1">10_000</span>),
]);
</code></pre><h2 id="resolveby"><a class="markdown-permalink" href="#resolveby"><span class="icon icon-link"></span></a><code>resolveBy</code></h2><p><a href="#settle-an-executor">Resolves the executor</a> with values pushed by an <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Observable.html"><code>Observable</code><span class="external"></span></a>.</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">Observable</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
</code></pre><p><a href="https://smikhalevski.github.io/parallel-universe/classes/PubSub.html"><code>PubSub</code><span class="external"></span></a> can be used to decouple the lazy data source from the executor:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">PubSub</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>parallel-universe<span class="pl-pds">'</span></span>;
...
</code></pre><p>Use <code>retryFulfilled</code> in conjunction with <a href="#retryrejected"><code>retryRejected</code></a> to create a polling sequence. For example, this configuration would infinitely poll the <code>heavyTask</code> and would retry failed iterations with an exponential backoff and no more then 3 times in a row:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-smi">heavyTask</span>, [
  <span class="pl-en">retryFulfilled</span>(),
  <span class="pl-en">retryRejected</span>({ count: <span class="pl-c1">5</span> }),
]);
</code></pre><p>You can also use a combination of <a href="#invalidateafter"><code>invalidateAfter</code></a> and <a href="#retryinvalidated"><code>retryInvalidated</code></a> to create an infinite polling regardless of the result of the previous iteration:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-smi">heavyTask</span>, [
...
<span class="pl-smi">executor</span>.<span class="pl-en">activate</span>();
</code></pre><p>Combine this plugin with <a href="#invalidatebypeers"><code>invalidateByPeers</code></a> to automatically retry this executor if another executor on which it depends becomes invalid:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">ExecutorTaskCallback</span>, <span class="pl-smi">useExecutor</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
<span class="pl-k">const</span> <span class="pl-en">fetchCheese</span><span class="pl-k">:</span> <span class="pl-en">ExecutorTaskCallback</span> <span class="pl-k">=</span> <span class="pl-k">async</span> (<span class="pl-v">signal</span>, <span class="pl-v">executor</span>) <span class="pl-k">=></span> {
...
</code></pre><p>With this plugin, you can synchronize the executor state <a href="https://stackblitz.com/edit/react-executor-todo-app?file=README.md">across multiple browser tabs<span class="external"></span></a> in just one line.</p><div class="markdown-alert markdown-alert-important"><p class="markdown-alert-title"><svg class="octicon octicon-report mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v9.5A1.75 1.75 0 0 1 14.25 13H8.06l-2.573 2.573A1.458 1.458 0 0 1 3 14.543V13H1.75A1.75 1.75 0 0 1 0 11.25Zm1.75-.25a.25.25 0 0 0-.25.25v9.5c0 .138.112.25.25.25h2a.75.75 0 0 1 .75.75v2.19l2.72-2.72a.749.749 0 0 1 .53-.22h6.5a.25.25 0 0 0 .25-.25v-9.5a.25.25 0 0 0-.25-.25Zm7 2.25v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>Important</p><p>If executor is <a href="#detach-an-executor">detached</a>, then the corresponding item is removed from the storage.</p></div><p>By default, an executor state is serialized using <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON"><code>JSON</code><span class="external"></span></a>. If your executor stores a value that may contain circular references, or non-serializable data like <code>BigInt</code>, use a custom serializer.</p><p>Here's how you can enable serialization of objects with circular references:</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">JSONMarshal</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>json-marshal<span class="pl-pds">'</span></span>;
...
</code></pre><div class="markdown-alert markdown-alert-tip"><p class="markdown-alert-title"><svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>Tip</p><p>With additional configuration, <a href="https://github.com/smikhalevski/json-marshal#readme">json-marshal<span class="external"></span></a> can stringify and parse any data structure.</p></div><p>By default, <code>syncBrowserStorage</code> plugin uses a <a href="#executor-keys">serialized executor key</a> as a storage key. You can provide a custom key via <a href="https://smikhalevski.github.io/react-executor/interfaces/plugin_syncBrowserStorage.SyncBrowserStorageOptions.html#storagekey"><code>storageKey</code><span class="external"></span></a> option:</p><pre><code class="language-ts"><span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-c1">42</span>, [<span class="pl-en">syncBrowserStorage</span>({ storageKey: <span class="pl-s"><span class="pl-pds">'</span>hello<span class="pl-pds">'</span></span> })]);
...
</code></pre><p>When executor is <a href="#settle-an-executor">settled</a>, <a href="#clear-an-executor">cleared</a>, <a href="#invalidate-results">invalidated</a> or annotated then the plugin calls the <a href="https://smikhalevski.github.io/react-executor/interfaces/plugin_syncExternalStore.ExternalStore.html#set"><code>ExternalStore.set</code><span class="external"></span></a> method on the store.</p><p>When executor is <a href="#detach-an-executor">detached</a> then the plugin calls the <a href="https://smikhalevski.github.io/react-executor/interfaces/plugin_syncExternalStore.ExternalStore.html#delete"><code>ExternalStore.delete</code><span class="external"></span></a> method on the store.</p><p>Prefer <a href="#syncbrowserstorage"><code>syncBrowserStorage</code></a> if you want to persist the executor state in a <code>localStorage</code> or <code>sessionStorage</code>.</p><h1 id="observables"><a class="markdown-permalink" href="#observables"><span class="icon icon-link"></span></a>Observables</h1><p>Observables are values that can be passed to any <code>*When</code> plugin (<code>abortWhen</code>, <code>invalidateWhen</code>, <code>retryWhen</code>, <code>resolveBy</code>). They follow a minimal interface: a <code>subscribe</code> method that calls a listener whenever the value changes and returns an unsubscribe callback. You can pass any object matching this interface — including third-party reactive primitives — as an observable.</p><p>Four built-in observables are provided out of the box:</p><h2 id="navigatoronline"><a class="markdown-permalink" href="#navigatoronline"><span class="icon icon-link"></span></a><code>navigatorOnline</code></h2><p>Emits <code>true</code> when the device is connected to the network, and <code>false</code> when it is disconnected.</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">retryWhen</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/retryWhen<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">navigatorOnline</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/observable/navigatorOnline<span class="pl-pds">'</span></span>;

<span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-smi">heavyTask</span>, [<span class="pl-en">retryWhen</span>(<span class="pl-smi">navigatorOnline</span>)]);
</code></pre><h2 id="navigatoroffline"><a class="markdown-permalink" href="#navigatoroffline"><span class="icon icon-link"></span></a><code>navigatorOffline</code></h2><p>The inverse of <code>navigatorOnline</code>. Emits <code>true</code> when the device is disconnected.</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">abortWhen</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/abortWhen<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">navigatorOffline</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/observable/navigatorOffline<span class="pl-pds">'</span></span>;

<span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-smi">heavyTask</span>, [<span class="pl-en">abortWhen</span>(<span class="pl-smi">navigatorOffline</span>)]);
</code></pre><h2 id="windowfocused"><a class="markdown-permalink" href="#windowfocused"><span class="icon icon-link"></span></a><code>windowFocused</code></h2><p>Emits <code>true</code> when the window receives focus, and <code>false</code> when it loses focus.</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">retryWhen</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/retryWhen<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">windowFocused</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/observable/windowFocused<span class="pl-pds">'</span></span>;

<span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-smi">heavyTask</span>, [<span class="pl-en">retryWhen</span>(<span class="pl-smi">windowFocused</span>)]);
</code></pre><h2 id="windowblurred"><a class="markdown-permalink" href="#windowblurred"><span class="icon icon-link"></span></a><code>windowBlurred</code></h2><p>The inverse of <code>windowFocused</code>. Emits <code>true</code> when the window loses focus.</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">abortWhen</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/abortWhen<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">windowBlurred</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/observable/windowBlurred<span class="pl-pds">'</span></span>;

<span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-smi">heavyTask</span>, [<span class="pl-en">abortWhen</span>(<span class="pl-smi">windowBlurred</span>)]);
</code></pre><h1 id="react-integration"><a class="markdown-permalink" href="#react-integration"><span class="icon icon-link"></span></a>React integration</h1><p>In the basic scenario, to use executors in your React app, you don't need any additional configuration, just use the <a href="https://smikhalevski.github.io/react-executor/functions/react-executor.useExecutor.html"><code>useExecutor</code><span class="external"></span></a> hook right away:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">useExecutor</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
</code></pre><p>Every time the executor's state is changed, the component is re-rendered. The executor returned from the hook is <a href="#activate-an-executor">activated</a> after mount and deactivated on unmount.</p><p>The hook has the exact same signature as the <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html#getorcreate"><code>ExecutorManager.getOrCreate</code><span class="external"></span></a> method, described in the <a href="#introduction">Introduction</a> section.</p><div class="markdown-alert markdown-alert-tip"><p class="markdown-alert-title"><svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>Tip</p><p>Check out the live example of <a href="https://stackblitz.com/edit/react-executor-todo-app?file=README.md">the TODO app<span class="external"></span></a> that employs React Executor.</p></div><p>You can use executors both inside and outside the rendering process. To do this, provide a custom <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html"><code>ExecutorManager</code><span class="external"></span></a> through the context:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">ExecutorManager</span>, <span class="pl-smi">ExecutorManagerProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
</code></pre><p>If you want to have access to an executor in a component, but don't want to re-render the component when the executor's state is changed, use <a href="https://smikhalevski.github.io/react-executor/functions/react-executor.useExecutorManager.html"><code>useExecutorManager</code><span class="external"></span></a> hook:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">accountExecutor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutorManager</span>().<span class="pl-en">getOrCreate</span>(<span class="pl-s"><span class="pl-pds">'</span>account<span class="pl-pds">'</span></span>);
...
</code></pre><h2 id="suspense"><a class="markdown-permalink" href="#suspense"><span class="icon icon-link"></span></a>Suspense</h2><p>Executors support fetch-as-you-render approach and can be integrated with React Suspense. To facilitate the rendering suspension, use the <a href="https://smikhalevski.github.io/react-executor/functions/react-executor.useExecutorSuspense.html"><code>useExecutorSuspense</code><span class="external"></span></a> hook:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">useExecutor</span>, <span class="pl-smi">useExecutorSuspense</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
</code></pre><h1 id="server-side-rendering"><a class="markdown-permalink" href="#server-side-rendering"><span class="icon icon-link"></span></a>Server-side rendering</h1><div class="markdown-alert markdown-alert-tip"><p class="markdown-alert-title"><svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>Tip</p><p>Check out the live example of <a href="https://codesandbox.io/p/devbox/react-executor-ssr-streaming-example-mwrmrs">streaming SSR<span class="external"></span></a> with React Executor.</p></div><p>Executors can be hydrated on the client after being settled on the server.</p><p>To enable hydration on the client, create the executor manager and provide it through a context:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">hydrateRoot</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-dom/client<span class="pl-pds">'</span></span>;
...
</code></pre><p>Here, <code>App</code> is the component that renders your application. Inside the <code>App</code> you can use <code>useExecutor</code> and <a href="#suspense"><code>useExecutorSuspense</code></a> to load your data.</p><p><a href="https://smikhalevski.github.io/react-executor/functions/react-executor.hydrateExecutorManager.html"><code>hydrateExecutorManager</code><span class="external"></span></a> must be called only once on the client-side with the manager that would receive the dehydrated state from the server.</p><p>On the server-side, you can either render your app contents <a href="#render-to-string">as a string</a> and send it to the client in one go, or <a href="#streaming-ssr">stream the contents</a>.</p><h2 id="render-to-string"><a class="markdown-permalink" href="#render-to-string"><span class="icon icon-link"></span></a>Render to string</h2><p>Use <a href="https://smikhalevski.github.io/react-executor/classes/ssr.SSRExecutorManager.html"><code>SSRExecutorManager</code><span class="external"></span></a> to render your app as an HTML string:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">createServer</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>node:http<span class="pl-pds">'</span></span>;
...
</code></pre><p>A new executor manager must be created for each request, so the results that are stored in executors are served in response to a particular request.</p><p><a href="https://smikhalevski.github.io/react-executor/classes/ssr.SSRExecutorManager.html#haschanges"><code>hasChanges</code><span class="external"></span></a> would resolve with <code>true</code> if state of some executors have changed during rendering.</p><div class="markdown-alert markdown-alert-warning"><p class="markdown-alert-title"><svg class="octicon octicon-alert mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>Warning</p><p>Plugins that continuously re-execute tasks — such as <a href="#retryfulfilled"><code>retryFulfilled</code></a> with a short delay — will cause <code>hasChanges()</code> to loop indefinitely. Avoid polling plugins in SSR, or pass <code>maxRetries</code> to cap the number of iterations.</p></div><p>The hydration chunk returned by <a href="https://smikhalevski.github.io/react-executor/classes/ssr.SSRExecutorManager.html#nexthydrationchunk"><code>nextHydrationChunk</code><span class="external"></span></a> contains the <code>&#x3C;script></code> tag that hydrates the manager for which <a href="https://smikhalevski.github.io/react-executor/functions/react-executor.hydrateExecutorManager.html"><code>hydrateExecutorManager</code><span class="external"></span></a> was invoked.</p><h2 id="streaming-ssr"><a class="markdown-permalink" href="#streaming-ssr"><span class="icon icon-link"></span></a>Streaming SSR</h2><p>React can stream parts of your app while it is being rendered. You can inject React Executor hydration chunks into the React stream.</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">createServer</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>node:http<span class="pl-pds">'</span></span>;
...
<span class="pl-smi">server</span>.<span class="pl-en">listen</span>(<span class="pl-c1">8080</span>);
</code></pre><p><code>hydrator</code> injects React Executor hydration chunks into the React stream.</p><p>In the <code>App</code> component, use the combination of <a href="https://react.dev/reference/react/Suspense"><code>&#x3C;Suspense></code><span class="external"></span></a>, <a href="https://smikhalevski.github.io/react-executor/functions/react-executor.useExecutor.html"><code>useExecutor</code><span class="external"></span></a> and <a href="https://smikhalevski.github.io/react-executor/functions/react-executor.useExecutorSuspense.html"><code>useExecutorSuspense</code><span class="external"></span></a> to suspend rendering while executors process their tasks:</p><pre><code class="language-tsx"><span class="pl-k">function</span> <span class="pl-en">App</span>() {
...
</code></pre><p>If the <code>App</code> is rendered in streaming mode, it would first show "Loading" and after the executor is settled, it would update to "Hello, Paul!". In the meantime <code>helloExecutor</code> on the client would be hydrated with the data from the server.</p><h2 id="state-serialization"><a class="markdown-permalink" href="#state-serialization"><span class="icon icon-link"></span></a>State serialization</h2><p>By default, an executor state is serialized using <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON"><code>JSON</code><span class="external"></span></a> that has quite a few limitations. If your executor stores a value that may contain circular references, or non-serializable data like <code>BigInt</code>, then a custom state serializer must be provided.</p><p>On the server, pass a <a href="https://smikhalevski.github.io/react-executor/interfaces/ssr.SSRExecutorManagerOptions.html#serializer"><code>serializer</code><span class="external"></span></a> option to <a href="#render-to-string"><code>SSRExecutorManager</code></a>:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">SSRExecutorManager</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/ssr<span class="pl-pds">'</span></span>;
...
</code></pre><p>On the client, pass <em>the same</em> <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.HydrateExecutorManagerOptions.html#serializer"><code>serializer</code><span class="external"></span></a> to <code>hydrateExecutorManager</code>:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">hydrateRoot</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-dom/client<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">hydrateExecutorManager</span>, <span class="pl-smi">ExecutorManager</span>, <span class="pl-smi">ExecutorManagerProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">JSONMarshal</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>json-marshal<span class="pl-pds">'</span></span>;
...
</code></pre><div class="markdown-alert markdown-alert-tip"><p class="markdown-alert-title"><svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>Tip</p><p>With additional configuration, <a href="https://github.com/smikhalevski/json-marshal#readme">json-marshal<span class="external"></span></a> can stringify and parse any data structure.</p></div><h2 id="content-security-policy-support"><a class="markdown-permalink" href="#content-security-policy-support"><span class="icon icon-link"></span></a>Content-Security-Policy support</h2><p>By default, <a href="https://smikhalevski.github.io/react-executor/classes/ssr.SSRExecutorManager.html#nexthydrationchunk"><code>nextHydrationChunk</code><span class="external"></span></a> renders an inline <code>&#x3C;script></code> tag without any attributes. To enable the support of the <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/script-src"><code>script-src</code><span class="external"></span></a> directive of the <code>Content-Security-Policy</code> header, provide the <a href="https://smikhalevski.github.io/react-executor/interfaces/ssr.SSRExecutorManagerOptions.html#nonce"><code>nonce</code><span class="external"></span></a> option to <code>SSRExecutorManager</code> or any of its subclasses:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">manager</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">SSRExecutorManager</span>(<span class="pl-smi">response</span>, { nonce: <span class="pl-s"><span class="pl-pds">'</span>2726c7f26c<span class="pl-pds">'</span></span> });
...
</code></pre><h2 id="nextjs-integration"><a class="markdown-permalink" href="#nextjs-integration"><span class="icon icon-link"></span></a>Next.js integration</h2><div class="markdown-alert markdown-alert-tip"><p class="markdown-alert-title"><svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>Tip</p><p>Check out the live example of <a href="https://codesandbox.io/p/devbox/react-executor-next-example-whsj4v">the Next.js app<span class="external"></span></a> that showcases streaming SSR with React Executor.</p></div><p>To enable client hydration in Next.js, use <a href="https://github.com/smikhalevski/react-executor-next"><code>@react-executor/next</code><span class="external"></span></a> package.</p><p>First, provide an <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html"><code>ExecutorManager</code><span class="external"></span></a>:</p><pre><code class="language-tsx"><span class="pl-c">// providers.tsx</span>
...
</code></pre><p>Executors created by the <code>opaqueExecutorManager</code> won't be visible in the React Executor Devtools extension. It is recommended to use this setting in production.</p><p>The extension source can be found in the <a href="https://github.com/smikhalevski/react-executor-devtools">react-executor-devtools<span class="external"></span></a> repo.</p><h1 id="cookbook"><a class="markdown-permalink" href="#cookbook"><span class="icon icon-link"></span></a>Cookbook</h1><h2 id="dependent-tasks"><a class="markdown-permalink" href="#dependent-tasks"><span class="icon icon-link"></span></a>Dependent tasks</h2><p>Pause a task until another executor is settled:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">accountExecutor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>account<span class="pl-pds">'</span></span>, <span class="pl-k">async</span> <span class="pl-v">signal</span> <span class="pl-k">=></span> {
...
</code></pre><h2 id="derived-executors"><a class="markdown-permalink" href="#derived-executors"><span class="icon icon-link"></span></a>Derived executors</h2><p>An executor whose result depends on another executor can be re-computed automatically when that dependency changes. Combine <a href="#invalidatebypeers"><code>invalidateByPeers</code></a> and <a href="#retryinvalidated"><code>retryInvalidated</code></a> to wire this up:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">useExecutor</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">invalidateByPeers</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/invalidateByPeers<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">retryInvalidated</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/retryInvalidated<span class="pl-pds">'</span></span>;

<span class="pl-k">const</span> <span class="pl-c1">breadExecutor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>bread<span class="pl-pds">'</span></span>, <span class="pl-smi">fetchBread</span>);

<span class="pl-k">const</span> <span class="pl-c1">cheeseExecutor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(
  <span class="pl-s"><span class="pl-pds">'</span>cheese<span class="pl-pds">'</span></span>,
  <span class="pl-k">async</span> <span class="pl-v">signal</span> <span class="pl-k">=></span> {
    <span class="pl-k">const</span> <span class="pl-c1">bread</span> <span class="pl-k">=</span> <span class="pl-k">await</span> <span class="pl-smi">breadExecutor</span>.<span class="pl-en">getOrAwait</span>();
    <span class="pl-k">return</span> <span class="pl-en">bestCheeseFor</span>(<span class="pl-smi">bread</span>);
  },
  [<span class="pl-en">invalidateByPeers</span>([<span class="pl-smi">breadExecutor</span>]), <span class="pl-en">retryInvalidated</span>()]
);
</code></pre><p><code>cheeseExecutor</code> re-runs whenever <code>breadExecutor</code> is fulfilled or invalidated. For bidirectional invalidation — where fulfilling either executor invalidates the other — add <a href="#invalidatepeers"><code>invalidatePeers</code></a> to both.</p><h2 id="pagination"><a class="markdown-permalink" href="#pagination"><span class="icon icon-link"></span></a>Pagination</h2><p>Create an executor that would store the current page contents:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-en">fetchPage</span> <span class="pl-k">=</span> <span class="pl-k">async</span> (<span class="pl-v">pageIndex</span><span class="pl-k">:</span> <span class="pl-c1">number</span>, <span class="pl-v">signal</span><span class="pl-k">:</span> <span class="pl-en">AbortSignal</span>) <span class="pl-k">=></span> {
...
</code></pre><h2 id="invalidate-all-executors"><a class="markdown-permalink" href="#invalidate-all-executors"><span class="icon icon-link"></span></a>Invalidate all executors</h2><p><a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html#_iterator_"><code>ExecutorManager</code><span class="external"></span></a> is iterable and provides access to all executors that it has created. You can perform batch operations with all executors in a for-loop:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">manager</span> <span class="pl-k">=</span> <span class="pl-en">useExecutorManager</span>();
...
</code></pre><p>By default, invalidating an executor has no additional effect. If you want to <a href="#retry-the-latest-task">retry the latest task</a> that each executor has executed, use <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#retry"><code>retry</code><span class="external"></span></a>:</p><pre><code class="language-ts"><span class="pl-k">for</span> (<span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">of</span> <span class="pl-smi">manager</span>) {
  <span class="pl-smi">executor</span>.<span class="pl-en">retry</span>();
}
</code></pre><p>It isn't optimal to retry all executors even if they aren't <a href="#activate-an-executor">actively used</a>. Use the <a href="https://smikhalevski.github.io/react-executor/modules/plugin_retryInvalidated.html"><code>retryInvalidated</code><span class="external"></span></a> to retry active executors when they are invalidated.</p><h2 id="prefetching"><a class="markdown-permalink" href="#prefetching"><span class="icon icon-link"></span></a>Prefetching</h2><p>In some cases, you can initialize an executor before its data is required for the first time:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-en">User</span> <span class="pl-k">=</span> () <span class="pl-k">=></span> {
...
<span class="pl-c">// ⮕ 0.5</span>
...
</code></pre><h2 id="global-loading-indicator"><a class="markdown-permalink" href="#global-loading-indicator"><span class="icon icon-link"></span></a>Global loading indicator</h2><p>To detect a global pending state we can rely on events published by an <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html"><code>ExecutorManager</code><span class="external"></span></a>:</p><pre><code class="language-ts"><span class="pl-k">function</span> <span class="pl-en">useIsPending</span>(<span class="pl-en">predicate</span> <span class="pl-k">=</span> (<span class="pl-v">executor</span><span class="pl-k">:</span> <span class="pl-en">Executor</span>) <span class="pl-k">=></span> <span class="pl-c1">true</span>)<span class="pl-k">:</span> <span class="pl-c1">boolean</span> {
  ...
  <span class="pl-en">useEffect</span>(() <span class="pl-k">=></span> {
    <span class="pl-k">const</span> <span class="pl-en">syncIsPending</span> <span class="pl-k">=</span> (<span class="pl-v">event</span><span class="pl-k">:</span> <span class="pl-en">ExecutorEvent</span>) <span class="pl-k">=></span> {
      <span class="pl-en">setPending</span>(<span class="pl-c1">Array</span>.<span class="pl-en">from</span>(<span class="pl-smi">manager</span>).<span class="pl-en">some</span>(<span class="pl-v">executor</span> <span class="pl-k">=></span> <span class="pl-en">predicate</span>(<span class="pl-smi">executor</span>) <span class="pl-k">&#x26;&#x26;</span> <span class="pl-smi">executor</span>.<span class="pl-smi">isPending</span>));
    };

    <span class="pl-c">// 1️⃣ Ensure isPending is up-to-date after mount</span>
    <span class="pl-en">syncIsPending</span>();

    <span class="pl-c">// 2️⃣ Sync isPending when any event is published</span>
    <span class="pl-k">return</span> <span class="pl-smi">manager</span>.<span class="pl-en">subscribe</span>(<span class="pl-smi">syncIsPending</span>);
  }, [<span class="pl-smi">manager</span>]);

  <span class="pl-k">return</span> <span class="pl-smi">isPending</span>;
}
</code></pre><p>Now a global pending indicator can be shown when <em>any</em> executor is pending:</p><pre><code class="language-tsx"><span class="pl-k">const</span> <span class="pl-c1">isPending</span> <span class="pl-k">=</span> <span class="pl-en">useIsPending</span>();
...
<span class="pl-smi">isPending</span> <span class="pl-k">&#x26;&#x26;</span> &#x3C;<span class="pl-c1">LoadingIndicator</span> />;
  ...
  () <span class="pl-k">=></span> <span class="pl-en">fetch</span>(<span class="pl-s"><span class="pl-pds">'</span>/account<span class="pl-pds">'</span></span>),
...
<span class="pl-k">const</span> <span class="pl-c1">isPending</span> <span class="pl-k">=</span> <span class="pl-en">useIsPending</span>(<span class="pl-v">executor</span> <span class="pl-k">=></span> <span class="pl-smi">executor</span>.<span class="pl-smi">annotations</span>.<span class="pl-smi">isFetching</span>);
</code></pre>`};function l(){return s.createElement(a,{logo:s.createElement(`div`,{style:o(n,r),className:i.Logo,title:`React Executor`}),readme:c})}export{l as default};