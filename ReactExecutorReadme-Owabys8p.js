import{b as s}from"./vendor-BmysqiTO.js";import{r as a,a as p}from"./react-executor-logo-dark-CZ4RcBb3.js";import{R as n}from"./Readme-Bw0CmbWL.js";import{l as e}from"./utils-D7qyeKq7.js";import"./index-0h_5AAv6.js";const l={version:"0.0.25",overviewContent:`<p>Asynchronous task execution and state management for React.</p><ul><li>TypeScript first;</li><li>Expressive and concise API with strict typings;</li><li>Works great with SSR and Suspense;</li><li><a href="#plugins">Extensible with plugins</a>;</li><li><a href="#devtools">First class devtools</a>;</li><li><a href="https://pkg-size.dev/react-executor">Just 5 kB gzipped</a>;</li><li>Check out the <a href="#cookbook">Cookbook</a> for real-life examples!</li></ul><pre><code class="language-sh">npm install --save-prod react-executor
</code></pre>`,tocContent:'<p>🔥 <strong>Live examples</strong></p><ul><li><a href="https://stackblitz.com/edit/react-executor-todo-app?file=README.md">TODO app</a></li><li><a href="https://codesandbox.io/p/devbox/react-executor-ssr-streaming-example-mwrmrs">Streaming SSR</a></li><li><a href="https://codesandbox.io/p/devbox/react-executor-next-example-whsj4v">Next.js integration</a></li></ul><p>🔰 <a href="#introduction"><strong>Introduction</strong></a></p><ul><li><a href="#executor-keys">Executor keys</a></li><li><a href="#execute-a-task">Execute a task</a></li><li><a href="#abort-a-task">Abort a task</a></li><li><a href="#replace-a-task">Replace a task</a></li><li><a href="#wait-for-a-task-to-complete">Wait for a task to complete</a></li><li><a href="#retry-the-latest-task">Retry the latest task</a></li><li><a href="#settle-an-executor">Settle an executor</a></li><li><a href="#clear-an-executor">Clear an executor</a></li></ul><p>📢 <a href="#events-and-lifecycle"><strong>Events and lifecycle</strong></a></p><ul><li><a href="#activate-an-executor">Activate an executor</a></li><li><a href="#invalidate-results">Invalidate results</a></li><li><a href="#detach-an-executor">Detach an executor</a></li></ul><p>🔌 <a href="#plugins"><strong>Plugins</strong></a></p><ul><li><a href="#abortdeactivated"><code>abortDeactivated</code></a></li><li><a href="#abortpendingafter"><code>abortPendingAfter</code></a></li><li><a href="#abortwhen"><code>abortWhen</code></a></li><li><a href="#bindall"><code>bindAll</code></a></li><li><a href="#detachdeactivated"><code>detachDeactivated</code></a></li><li><a href="#detachinactive"><code>detachInactive</code></a></li><li><a href="#invalidateafter"><code>invalidateAfter</code></a></li><li><a href="#invalidatebypeers"><code>invalidateByPeers</code></a></li><li><a href="#invalidatepeers"><code>invalidatePeers</code></a></li><li><a href="#rejectpendingafter"><code>rejectPendingAfter</code></a></li><li><a href="#resolveby"><code>resolveBy</code></a></li><li><a href="#retryactivated"><code>retryActivated</code></a></li><li><a href="#retryfulfilled"><code>retryFulfilled</code></a></li><li><a href="#retryinvalidated"><code>retryInvalidated</code></a></li><li><a href="#retryrejected"><code>retryRejected</code></a></li><li><a href="#retrywhen"><code>retryWhen</code></a></li><li><a href="#synchronizestorage"><code>synchronizeStorage</code></a></li></ul><p>⚛️ <a href="#react-integration"><strong>React integration</strong></a></p><ul><li><a href="#suspense">Suspense</a></li><li><a href="#external-executors">External executors</a></li></ul><p>🚀 <a href="#server-side-rendering"><strong>Server-side rendering</strong></a></p><ul><li><a href="#render-to-string">Render to string</a></li><li><a href="#streaming-ssr">Streaming SSR</a></li><li><a href="#state-serialization">State serialization</a></li><li><a href="#content-security-policy-support">Content-Security-Policy support</a></li><li><a href="#nextjs-integration">Next.js integration</a></li></ul><p>⚙️ <a href="#devtools"><strong>Devtools</strong></a></p><p>🍪 <strong>Cookbook</strong></p><ul><li><a href="#optimistic-updates">Optimistic updates</a></li><li><a href="#dependent-tasks">Dependent tasks</a></li><li><a href="#pagination">Pagination</a></li><li><a href="#infinite-scroll">Infinite scroll</a></li><li><a href="#invalidate-all-executors">Invalidate all executors</a></li><li><a href="#prefetching">Prefetching</a></li><li><a href="#storage-state-versioning">Storage state versioning</a></li><li><a href="#global-loading-indicator">Global loading indicator</a></li></ul>',articleContent:`<h1 id="introduction"><a class="markdown-permalink" href="#introduction"><span class="icon icon-link"></span></a>Introduction</h1><p>An executor executes a task, stores the execution result, and provides access to it. Tasks are callbacks that return a value or throw an error.</p><p>An <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html"><code>Executor</code></a> is created and managed by an <a href="https://smikhalevski.github.io/react-executor/classes/react_executor.ExecutorManager.html"><code>ExecutorManager</code></a> which controls the executor lifecycle:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">ExecutorManager</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
</code></pre><p>Each executor has a unique key in the scope of the manager. Here we created the new executor with the key <code>'rooky'</code>. Managers create a new executor when you call <a href="https://smikhalevski.github.io/react-executor/classes/react_executor.ExecutorManager.html#getOrCreate"><code>getOrCreate</code></a> with a new key. Each consequent call with that key returns the same executor.</p><p>If you want to retrieve an existing executor by its key and don't want to create a new executor if it doesn't exist, use <a href="https://smikhalevski.github.io/react-executor/classes/react_executor.ExecutorManager.html#get"><code>get</code></a>:</p><pre><code class="language-ts"><span class="pl-smi">manager</span>.<span class="pl-c1">get</span>(<span class="pl-s"><span class="pl-pds">'</span>bobby<span class="pl-pds">'</span></span>);
...
</code></pre><p>Plugins can subscribe to <a href="#events-and-lifecycle">executor events</a> or alter the executor instance. Read more about plugins in the <a href="#plugins">Plugins</a> section.</p><h2 id="executor-keys"><a class="markdown-permalink" href="#executor-keys"><span class="icon icon-link"></span></a>Executor keys</h2><p>Anything can be an executor key: a string, a number, an object, etc. By default, keys are considered identical if their <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON"><code>JSON</code></a>-serialized form is identical:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">manager</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">ExecutorManager</span>();
...
</code></pre><p>To override, how keys are serialized pass <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.ExecutorManagerOptions.html#keySerializer"><code>keySerializer</code></a> option to the <code>ExecutorManager</code> constructor. Key serializer is a function that receives the requested executor key and returns its serialized form. The returned serialized key form can be anything, a string, or an object.</p><p>If you're using objects as executor keys, then you may want to enable stable serialization (when keys are sorted alphabetically during serialization). In this case use any library that supports stable JSON serialization:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">stringify</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>json-marshal<span class="pl-pds">'</span></span>;
...
</code></pre><p><code>helloTask</code> receives an <a href="https://developer.mozilla.org/en-US/docs/Web/API/AbortSignal"><code>AbortSignal</code></a> and <code>rookyExecutor</code> as arguments. The signal is aborted if the task is <a href="#abort-a-task">aborted</a> or <a href="#replace-a-task">replaced</a>.</p><p>While tasks can be synchronous or asynchronous, executors always handle them in an asynchronous fashion. The executor is marked as <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#isPending">pending</a> immediately after <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#execute"><code>execute</code></a> is called:</p><pre><code class="language-ts"><span class="pl-c">// The executor is waiting for the task to complete</span>
...
</code></pre><p>The executor keeps track of the <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#task">latest task</a> it has executed:</p><pre><code class="language-ts"><span class="pl-smi">rookyExecutor</span>.<span class="pl-smi">task</span>;
...
</code></pre><p>Executors always preserve the latest value and the latest reason. So even when the executor <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#isPending"><code>isPending</code></a>, you can access the previous value or failure reason. Use <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#isFulfilled"><code>isFulfilled</code></a> and <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#isRejected"><code>isRejected</code></a> to detect with what result the executor has settled the last time. An executor cannot be both fulfilled and rejected at the same time.</p><pre><code class="language-ts"><span class="pl-c">// Execute a new task</span>
...
</code></pre><h2 id="abort-a-task"><a class="markdown-permalink" href="#abort-a-task"><span class="icon icon-link"></span></a>Abort a task</h2><p>The promise returned by the <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#execute"><code>execute</code></a> method is <a href="https://smikhalevski.github.io/parallel-universe/classes/AbortablePromise.html">abortable</a> so the task can be prematurely aborted. Results of the aborted task are discarded:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">helloPromise</span> <span class="pl-k">=</span> <span class="pl-smi">rookyExecutor</span>.<span class="pl-en">execute</span>(<span class="pl-k">async</span> () <span class="pl-k">=></span> <span class="pl-s"><span class="pl-pds">'</span>Hello<span class="pl-pds">'</span></span>);
...
</code></pre><h2 id="retry-the-latest-task"><a class="markdown-permalink" href="#retry-the-latest-task"><span class="icon icon-link"></span></a>Retry the latest task</h2><p>To retry the <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#task">latest task</a>, use <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#retry"><code>retry</code></a>:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">planets</span> <span class="pl-k">=</span> [<span class="pl-s"><span class="pl-pds">'</span>Mars<span class="pl-pds">'</span></span>, <span class="pl-s"><span class="pl-pds">'</span>Venus<span class="pl-pds">'</span></span>];
...
<span class="pl-smi">executor</span>.<span class="pl-en">retry</span>();
</code></pre><h2 id="settle-an-executor"><a class="markdown-permalink" href="#settle-an-executor"><span class="icon icon-link"></span></a>Settle an executor</h2><p>While tasks are always handled in an asynchronous fashion, there are cases when an executor should be settled synchronously.</p><p>Executor can be synchronously fulfilled via <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#resolve"><code>resolve</code></a>:</p><pre><code class="language-ts"><span class="pl-smi">executor</span>.<span class="pl-c1">resolve</span>(<span class="pl-s"><span class="pl-pds">'</span>Venus<span class="pl-pds">'</span></span>);
...
<span class="pl-smi">executor</span>.<span class="pl-c1">value</span>;
<span class="pl-c">// ⮕ 'Venus'</span>
</code></pre><p>Or rejected via <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#reject"><code>reject</code></a>:</p><pre><code class="language-ts"><span class="pl-smi">executor</span>.<span class="pl-c1">reject</span>(<span class="pl-k">new</span> <span class="pl-c1">Error</span>(<span class="pl-s"><span class="pl-pds">'</span>Ooops!<span class="pl-pds">'</span></span>));
...
<span class="pl-smi">executor</span>.<span class="pl-c1">value</span>;
<span class="pl-c">// ⮕ 'Mars'</span>
</code></pre><h2 id="clear-an-executor"><a class="markdown-permalink" href="#clear-an-executor"><span class="icon icon-link"></span></a>Clear an executor</h2><p>After the executor becomes <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#isSettled">settled</a>, it remains settled until it is cleared.</p><p>You can reset the executor back to its unsettled state using <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#clear"><code>clear</code></a>:</p><pre><code class="language-ts"><span class="pl-smi">executor</span>.<span class="pl-c1">clear</span>();
</code></pre><p>Clearing an executor removes the stored value and reason, but <em>doesn't</em> affect the pending task execution and preserves the <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#task">latest task</a> that was executed.</p><h1 id="events-and-lifecycle"><a class="markdown-permalink" href="#events-and-lifecycle"><span class="icon icon-link"></span></a>Events and lifecycle</h1><p>Executors publish various events when their state changes. To subscribe to executor events use the <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#subscribe"><code>subscribe</code></a> method:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">manager</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">ExecutorManager</span>();
...
</code></pre><p>Both executors and managers may have multiple subscribers and each subscriber receives <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.ExecutorEvent.html">events</a> with following types:</p><dl><dt>attached</dt><dd><p>The executor was just created, plugins were applied to it, and it was attached to the manager. Read more about plugins in the <a href="#plugins">Plugins</a> section.</p></dd><dt>detached</dt><dd><p>The executor was just detached: it was removed from the manager and all of its subscribers were unsubscribed. Read more in the <a href="#detach-an-executor">Detach an executor</a> section.</p></dd><dt>activated</dt><dd><p>The executor was inactive and became active. This means that there are consumers that observe the state of the executor. Read more in the <a href="#activate-an-executor">Activate an executor</a> section.</p></dd><dt>deactivated</dt><dd><p>The executor was active and became inactive. This means that there are no consumers that observe the state of the executor. Read more in the <a href="#activate-an-executor">Activate an executor</a> section.</p></dd><dt>pending</dt><dd><p>The executor started <a href="#execute-a-task">a task execution</a>. You can find the latest task the executor handled in the <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#task"><code>Executor.task</code></a> property.</p></dd><dt>fulfilled</dt><dd><p>The executor was fulfilled with a value.</p></dd><dt>rejected</dt><dd><p>The executor was rejected with a reason.</p></dd><dt>aborted</dt><dd><p>The <a href="#abort-a-task">task was aborted</a>.</p><p>If executor is still <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#isPending">pending</a> when an <code>'aborted'</code> event is published then the currently pending task is being <a href="#replace-a-task">replaced</a> with a new task.</p><p>Calling <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#execute"><code>Executor.execute</code></a> when handling an abort event may lead to stack overflow. If you need to do this anyway, execute a new task from async context using <a href="https://developer.mozilla.org/en-US/docs/Web/API/queueMicrotask"><code>queueMicrotask</code></a> or a similar API.</p></dd><dt>cleared</dt><dd><p>The executor was cleared and now isn't settled.</p></dd><dt>invalidated</dt><dd><p>Results stored in an executor were <a href="#invalidate-results">invalidated</a>.</p></dd><dt>annotated</dt><dd><p><a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#annotations">Annotations</a> associated with the executor were patched.</p></dd><dt>plugin_configured</dt><dd><p>The configuration of the plugin associated with the executor was updated.</p></dd></dl><h2 id="activate-an-executor"><a class="markdown-permalink" href="#activate-an-executor"><span class="icon icon-link"></span></a>Activate an executor</h2><p>Executors have an <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#isActive">active</a> status that tells whether executor is actively used by a consumer.</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">deactivate</span> <span class="pl-k">=</span> <span class="pl-smi">executor</span>.<span class="pl-en">activate</span>();
...
<span class="pl-smi">executor</span>.<span class="pl-smi">isInvalidated</span>;
<span class="pl-c">// ⮕ false</span>
</code></pre><p>By default, invalidating an executor has no effect except marking it as <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#isInvalidated">invalidated</a>.</p><h2 id="detach-an-executor"><a class="markdown-permalink" href="#detach-an-executor"><span class="icon icon-link"></span></a>Detach an executor</h2><p>By default, executors that a manager has created are preserved indefinitely and are always available though <a href="https://smikhalevski.github.io/react-executor/classes/react_executor.ExecutorManager.html#get"><code>get</code></a>. This isn't always optimal, and you may want to detach an executor when it isn't needed anymore. Use <a href="https://smikhalevski.github.io/react-executor/classes/react_executor.ExecutorManager.html#detach"><code>detach</code></a> in such case:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-smi">manager</span>.<span class="pl-en">getOrCreate</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>);
...
</code></pre><p>To apply a plugin, pass it to the <a href="https://smikhalevski.github.io/react-executor/classes/react_executor.ExecutorManager.html#getOrCreate"><code>ExecutorManager.getOrCreate</code></a> or to the <a href="https://smikhalevski.github.io/react-executor/functions/react_executor.useExecutor.html"><code>useExecutor</code></a> hook:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-smi">manager</span>.<span class="pl-en">getOrCreate</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-c1">undefined</span>, [<span class="pl-smi">detachPlugin</span>]);
...
</code></pre><p><a href="https://smikhalevski.github.io/parallel-universe/classes/PubSub.html"><code>PubSub</code></a> can be used do decouple the lazy data source from the executor:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">PubSub</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>parallel-universe<span class="pl-pds">'</span></span>;
...
</code></pre><h2 id="synchronizestorage"><a class="markdown-permalink" href="#synchronizestorage"><span class="icon icon-link"></span></a><code>synchronizeStorage</code></h2><p>Persists the executor value in the synchronous storage.</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">synchronizeStorage</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/synchronizeStorage<span class="pl-pds">'</span></span>;

<span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-c1">42</span>, [<span class="pl-en">synchronizeStorage</span>(<span class="pl-smi">localStorage</span>)]);
</code></pre><p>With this plugin, you can synchronize the executor state <a href="https://stackblitz.com/edit/react-executor-todo-app?file=README.md">across multiple browser tabs</a> in just one line.</p><div class="markdown-alert markdown-alert-important"><p class="markdown-alert-title"><svg class="octicon octicon-report mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v9.5A1.75 1.75 0 0 1 14.25 13H8.06l-2.573 2.573A1.458 1.458 0 0 1 3 14.543V13H1.75A1.75 1.75 0 0 1 0 11.25Zm1.75-.25a.25.25 0 0 0-.25.25v9.5c0 .138.112.25.25.25h2a.75.75 0 0 1 .75.75v2.19l2.72-2.72a.749.749 0 0 1 .53-.22h6.5a.25.25 0 0 0 .25-.25v-9.5a.25.25 0 0 0-.25-.25Zm7 2.25v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>Important</p><p>If executor is <a href="#detach-an-executor">detached</a>, then the corresponding item is removed from the storage.</p></div><p>By default, an executor state is serialized using <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON"><code>JSON</code></a>. If your executor stores a value that may contain circular references, or non-serializable data like <code>BigInt</code>, use a custom serializer.</p><p>Here's how you can enable serialization of objects with circular references:</p><pre><code class="language-ts"><span class="pl-k">import</span> <span class="pl-smi">JSONMarshal</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>json-marshal<span class="pl-pds">'</span></span>;

<span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-c1">42</span>, [
  <span class="pl-en">synchronizeStorage</span>(<span class="pl-smi">localStorage</span>, {
    serializer: <span class="pl-smi">JSONMarshal</span>,
  })
]);
</code></pre><div class="markdown-alert markdown-alert-tip"><p class="markdown-alert-title"><svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>Tip</p><p>With additional configuration, <a href="https://github.com/smikhalevski/json-marshal#readme">json-marshal</a> can stringify and parse any data structure.</p></div><p>By default, <code>synchronizeStorage</code> plugin uses a <a href="#executor-keys">serialized executor key</a> as a storage key. You can provide a custom key via <a href="https://smikhalevski.github.io/react-executor/interfaces/plugin_synchronizeStorage.SynchronizeStorageOptions.html#storageKey"><code>storageKey</code></a> option:</p><pre><code class="language-ts"><span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>test<span class="pl-pds">'</span></span>, <span class="pl-c1">42</span>, [
  <span class="pl-en">synchronizeStorage</span>(<span class="pl-smi">localStorage</span>, { storageKey: <span class="pl-s"><span class="pl-pds">'</span>helloBobr<span class="pl-pds">'</span></span> })
]);
  ...
  <span class="pl-k">typeof</span> <span class="pl-smi">localStorage</span> <span class="pl-k">!==</span> <span class="pl-s"><span class="pl-pds">'</span>undefined<span class="pl-pds">'</span></span> <span class="pl-k">?</span> <span class="pl-en">synchronizeStorage</span>(<span class="pl-smi">localStorage</span>) <span class="pl-k">:</span> <span class="pl-c1">null</span>
]);
</code></pre><h1 id="react-integration"><a class="markdown-permalink" href="#react-integration"><span class="icon icon-link"></span></a>React integration</h1><p>In the basic scenario, to use executors in your React app, you don't need any additional configuration, just use the <a href="https://smikhalevski.github.io/react-executor/functions/react_executor.useExecutor.html"><code>useExecutor</code></a> hook right away:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">useExecutor</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
</code></pre><p>Every time the executor's state is changed, the component is re-rendered. The executor returned from the hook is <a href="#activate-an-executor">activated</a> after mount and deactivated on unmount.</p><p>The hook has the exact same signature as the <a href="https://smikhalevski.github.io/react-executor/classes/react_executor.ExecutorManager.html#getOrCreate"><code>ExecutorManager.getOrCreate</code></a> method, described in the <a href="#introduction">Introduction</a> section.</p><div class="markdown-alert markdown-alert-tip"><p class="markdown-alert-title"><svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>Tip</p><p>Check out the live example of <a href="https://stackblitz.com/edit/react-executor-todo-app?file=README.md">the TODO app</a> that employs React Executor.</p></div><p>You can use executors both inside and outside the rendering process. To do this, provide a custom <a href="https://smikhalevski.github.io/react-executor/classes/react_executor.ExecutorManager.html"><code>ExecutorManager</code></a> through the context:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">ExecutorManager</span>, <span class="pl-smi">ExecutorManagerProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
</code></pre><p>If you want to have access to an executor in a component, but don't want to re-render the component when the executor's state is changed, use <a href="https://smikhalevski.github.io/react-executor/functions/react_executor.useExecutorManager.html"><code>useExecutorManager</code></a> hook:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">accountExecutor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutorManager</span>().<span class="pl-en">getOrCreate</span>(<span class="pl-s"><span class="pl-pds">'</span>account<span class="pl-pds">'</span></span>);
...
</code></pre><h2 id="suspense"><a class="markdown-permalink" href="#suspense"><span class="icon icon-link"></span></a>Suspense</h2><p>Executors support fetch-as-you-render approach and can be integrated with React Suspense. To facilitate the rendering suspension, use the <a href="https://smikhalevski.github.io/react-executor/functions/react_executor.useExecutorSuspense.html"><code>useExecutorSuspense</code></a> hook:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">useExecutor</span>, <span class="pl-smi">useExecutorSuspense</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
</code></pre><p>Here, <code>App</code> is the component that renders your application. Inside the <code>App</code> you can use <code>useExecutor</code> and <a href="#suspense"><code>useExecutorSuspence</code></a> to load your data.</p><p><a href="https://smikhalevski.github.io/react-executor/functions/react_executor.enableSSRHydration.html"><code>enableSSRHydration</code></a> must be called only once, and only one manager on the client-side can receive the dehydrated state from the server.</p><p>On the server, you can either render your app contents <a href="#render-to-string">as a string</a> and send it to the client in one go, or <a href="#streaming-ssr">stream the contents</a>.</p><h2 id="render-to-string"><a class="markdown-permalink" href="#render-to-string"><span class="icon icon-link"></span></a>Render to string</h2><p>To render your app as an HTML string use <a href="https://smikhalevski.github.io/react-executor/classes/ssr.SSRExecutorManager.html"><code>SSRExecutorManager</code></a>:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">createServer</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>http<span class="pl-pds">'</span></span>;
...
</code></pre><p>A new executor manager must be created for each request, so the results that are stored in executors are served in response to a particular request.</p><p><a href="https://smikhalevski.github.io/react-executor/classes/ssr.SSRExecutorManager.html#hasChanges"><code>hasChanges</code></a> would resolve with <code>true</code> if state of some executors have changed during rendering.</p><p>The hydration chunk returned by <a href="https://smikhalevski.github.io/react-executor/classes/ssr.SSRExecutorManager.html#nextHydrationChunk"><code>nextHydrationChunk</code></a> contains the <code>&#x3C;script></code> tag that hydrates the manager for which <a href="https://smikhalevski.github.io/react-executor/functions/react_executor.enableSSRHydration.html"><code>enableSSRHydration</code></a> was invoked.</p><h2 id="streaming-ssr"><a class="markdown-permalink" href="#streaming-ssr"><span class="icon icon-link"></span></a>Streaming SSR</h2><p>Thanks to <a href="#suspense">Suspense</a>, React can stream parts of your app while it is being rendered. React Executor provides API to inject its hydration chunks into a streaming process. The API is different for NodeJS streams and <a href="https://developer.mozilla.org/en-US/docs/Web/API/ReadableStream">Readable Web Streams</a>.</p><p>In NodeJS environment use <a href="https://smikhalevski.github.io/react-executor/classes/ssr_node.PipeableSSRExecutorManager.html"><code>PipeableSSRExecutorManager</code></a></p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">createServer</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>http<span class="pl-pds">'</span></span>;
...
<span class="pl-smi">server</span>.<span class="pl-en">listen</span>(<span class="pl-c1">8080</span>);
</code></pre><p>State of executors is streamed to the client along with the chunks rendered by React.</p><p>In the <code>App</code> component, use the combination of <a href="https://react.dev/reference/react/Suspense"><code>&#x3C;Suspense></code></a>, <a href="https://smikhalevski.github.io/react-executor/functions/react_executor.useExecutor.html"><code>useExecutor</code></a> and <a href="https://smikhalevski.github.io/react-executor/functions/react_executor.useExecutorSuspense.html"><code>useExecutorSuspence</code></a> to suspend rendering while executors process their tasks:</p><pre><code class="language-tsx"><span class="pl-k">export</span> <span class="pl-k">const</span> <span class="pl-en">App</span> <span class="pl-k">=</span> () <span class="pl-k">=></span> (
...
</code></pre><p>If the <code>App</code> is rendered in streaming mode, it would first show "Loading" and after the executor is settled, it would update to "Hello, Paul!". In the meantime <code>helloExecutor</code> on the client would be hydrated with the data from the server.</p><h3 id="readable-web-streams-support"><a class="markdown-permalink" href="#readable-web-streams-support"><span class="icon icon-link"></span></a>Readable web streams support</h3><p>To enable streaming in a modern environment, use <a href="https://smikhalevski.github.io/react-executor/classes/ssr.ReadableSSRExecutorManager.html"><code>ReadableSSRExecutorManager</code></a></p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">renderToReadableStream</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-dom/server<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">ExecutorManagerProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
</code></pre><p>State of executors is streamed to the client along with the chunks rendered by React.</p><h2 id="state-serialization"><a class="markdown-permalink" href="#state-serialization"><span class="icon icon-link"></span></a>State serialization</h2><p>By default, an executor state is serialized using <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify"><code>JSON.stringify</code></a> that has quite a few limitations. If your executor stores a value that may contain circular references, or non-serializable data like <code>BigInt</code>, use a custom state serialization.</p><p>On the client, pass a <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.SSRHydrationOptions.html#stateParser"><code>stateParser</code></a> option to <code>enableSSRHydration</code>:</p><pre><code class="language-tsx"><span class="pl-k">import</span> <span class="pl-smi">React</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">hydrateRoot</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-dom/client<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">enableSSRHydration</span>, <span class="pl-smi">ExecutorManager</span>, <span class="pl-smi">ExecutorManagerProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
...
</code></pre><div class="markdown-alert markdown-alert-tip"><p class="markdown-alert-title"><svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>Tip</p><p>With additional configuration, <a href="https://github.com/smikhalevski/json-marshal#readme">json-marshal</a> can stringify and parse any data structure.</p></div><h2 id="content-security-policy-support"><a class="markdown-permalink" href="#content-security-policy-support"><span class="icon icon-link"></span></a>Content-Security-Policy support</h2><p>By default, <a href="https://smikhalevski.github.io/react-executor/classes/ssr.SSRExecutorManager.html#nextHydrationChunk"><code>nextHydrationChunk</code></a> renders an inline <code>&#x3C;script></code> tag without any attributes. To enable the support of the <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/script-src"><code>script-src</code></a> directive of the <code>Content-Security-Policy</code> header, provide the <a href="https://smikhalevski.github.io/react-executor/interfaces/ssr.SSRExecutorManagerOptions.html#nonce"><code>nonce</code></a> option to <code>SSRExecutorManager</code> or any of its subclasses:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">manager</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">PipeableSSRExecutorManager</span>(<span class="pl-smi">response</span>, { nonce: <span class="pl-s"><span class="pl-pds">'</span>2726c7f26c<span class="pl-pds">'</span></span> });
...
</code></pre><h2 id="nextjs-integration"><a class="markdown-permalink" href="#nextjs-integration"><span class="icon icon-link"></span></a>Next.js integration</h2><div class="markdown-alert markdown-alert-tip"><p class="markdown-alert-title"><svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>Tip</p><p>Check out the live example of <a href="https://codesandbox.io/p/devbox/react-executor-next-example-whsj4v">the Next.js app</a> that showcases streaming SSR with React Executor.</p></div><p>To enable client hydration in Next.js, use <a href="https://github.com/smikhalevski/react-executor-next"><code>@react-executor/next</code></a> package.</p><p>First, provide an <a href="https://smikhalevski.github.io/react-executor/classes/react_executor.ExecutorManager.html"><code>ExecutorManager</code></a>:</p><pre><code class="language-tsx"><span class="pl-c">// providers.tsx</span>
...
</code></pre><h2 id="invalidate-all-executors"><a class="markdown-permalink" href="#invalidate-all-executors"><span class="icon icon-link"></span></a>Invalidate all executors</h2><p><a href="https://smikhalevski.github.io/react-executor/classes/react_executor.ExecutorManager.html#_iterator_"><code>ExecutorManager</code></a> is iterable and provides access to all executors that it has created. You can perform bach operations with all executors in for-loop:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">manager</span> <span class="pl-k">=</span> <span class="pl-en">useExecutorManager</span>();
...
</code></pre><p>By default, invalidating an executor has no additional effect. If you want to <a href="#retry-the-latest-task">retry the latest task</a> that each executor has executed, use <a href="https://smikhalevski.github.io/react-executor/interfaces/react_executor.Executor.html#retry"><code>retry</code></a>:</p><pre><code class="language-ts"><span class="pl-k">for</span> (<span class="pl-k">const</span> <span class="pl-c1">executor</span> <span class="pl-k">of</span> <span class="pl-smi">manager</span>) {
  <span class="pl-smi">executor</span>.<span class="pl-en">retry</span>();
}
</code></pre><p>It isn't optimal to retry all executors even if they aren't <a href="#activate-an-executor">actively used</a>. Use the <a href="https://smikhalevski.github.io/react-executor/modules/plugin_retryInvalidated.html"><code>retryInvalidated</code></a> to retry active executors when they are invalidated.</p><h2 id="prefetching"><a class="markdown-permalink" href="#prefetching"><span class="icon icon-link"></span></a>Prefetching</h2><p>In some cases, you can initialize an executor before its data is required for the first time:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-en">User</span> <span class="pl-k">=</span> () <span class="pl-k">=></span> {
...
</code></pre><h2 id="storage-state-versioning"><a class="markdown-permalink" href="#storage-state-versioning"><span class="icon icon-link"></span></a>Storage state versioning</h2><p>You can store an executor state in a <code>localStorage</code> using the <a href="#synchronizestorage"><code>synchronizeStorage</code></a> plugin:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">useExecutor</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">synchronizeStorage</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor/plugin/synchronizeStorage<span class="pl-pds">'</span></span>;

<span class="pl-k">const</span> <span class="pl-c1">playerExecutor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>player<span class="pl-pds">'</span></span>, { health: <span class="pl-s"><span class="pl-pds">'</span>50%<span class="pl-pds">'</span></span> }, [<span class="pl-en">synchronizeStorage</span>(<span class="pl-smi">localStorage</span>)]);
<span class="pl-c">// ⮕ Executor&#x3C;{ health: string }></span>
</code></pre><p>But what if over time you'd like to change the structure of the value stored in the <code>playerExecutor</code>? For example, make <code>health</code> property a number:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">playerExecutor</span> <span class="pl-k">=</span> <span class="pl-en">useExecutor</span>(<span class="pl-s"><span class="pl-pds">'</span>player<span class="pl-pds">'</span></span>, { health: <span class="pl-c1">0.5</span> }, [<span class="pl-en">synchronizeStorage</span>(<span class="pl-smi">localStorage</span>)]);
...
</code></pre><h2 id="global-loading-indicator"><a class="markdown-permalink" href="#global-loading-indicator"><span class="icon icon-link"></span></a>Global loading indicator</h2><p>To detect a global pending state we can rely on events published by an <a href="https://smikhalevski.github.io/react-executor/classes/react_executor.ExecutorManager.html"><code>ExecutorManager</code></a>:</p><pre><code class="language-ts"><span class="pl-k">function</span> <span class="pl-en">useGlobalPending</span>(<span class="pl-en">predicate</span> <span class="pl-k">=</span> (<span class="pl-v">executor</span><span class="pl-k">:</span> <span class="pl-en">Executor</span>) <span class="pl-k">=></span> <span class="pl-c1">true</span>)<span class="pl-k">:</span> <span class="pl-c1">boolean</span> {
...
</code></pre>`};function d(){return s.createElement(n,{logo:s.createElement("div",{style:{...e(p,a),aspectRatio:1324/480,backgroundRepeat:"no-repeat",backgroundSize:"contain",maxWidth:"100%",width:"20rem"},title:"React Executor"}),readme:l})}export{d as default};
