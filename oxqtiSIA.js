import{b as s}from"./SnjZ_IlD.js";import{g as a,h as p}from"./CtQYgjR8.js";import{R as l}from"./DD9h4L8q.js";import{l as n}from"./VJBTubwY.js";import"./CfyWO84g.js";const e={version:"6.0.0",overviewContent:`<p>The form state management library that can handle hundreds of fields without breaking a sweat.</p><ul><li>Expressive and concise API with strict typings;</li><li>Controlled and <a href="#uncontrolled-plugin">uncontrolled inputs</a>;</li><li>Unparalleled extensibility with plugins;</li><li>Supports your favourite rendering and <a href="#validation-plugin">validation libraries</a>;</li><li><a href="https://bundlephobia.com/result?p=roqueform">Just 2 kB gzipped <sup>↗</sup></a>.</li></ul><pre><code class="language-sh">npm install --save-prod roqueform
</code></pre>`,tocContent:'<p><span class="toc-icon"></span><a href="https://github.com/smikhalevski/roqueform#readme"><strong>GitHub</strong> <sup>↗</sup></a></p><p><span class="toc-icon">🔥 </span><a href="https://stackblitz.com/edit/roqueform-example"><strong>Live example</strong> <sup>↗</sup></a></p><p><span class="toc-icon">🚀 </span><strong>Features</strong></p><ul><li><a href="#introduction">Introduction</a></li><li><a href="#events-and-subscriptions">Events and subscriptions</a></li><li><a href="#transient-updates">Transient updates</a></li><li><a href="#accessors">Accessors</a></li><li><a href="#plugins">Plugins</a></li></ul><p><span class="toc-icon">🔌 </span><strong>Built-in plugins</strong></p><ul><li><a href="#annotations-plugin">Annotations plugin</a></li><li><a href="#constraint-validation-api-plugin">Constraint validation API plugin</a></li><li><a href="#errors-plugin">Errors plugin</a></li><li><a href="#dom-element-reference-plugin">DOM element reference plugin</a></li><li><a href="#reset-plugin">Reset plugin</a></li><li><a href="#scroll-to-an-error-plugin">Scroll to an error plugin</a></li><li><a href="#uncontrolled-plugin">Uncontrolled plugin</a></li><li><a href="#validation-plugin">Validation plugin</a></li></ul><p><span class="toc-icon">⚛️ </span><a href="#react-integration"><strong>React integration</strong></a></p><ul><li><a href="#eager-and-lazy-re-renders">Eager and lazy re-renders</a></li><li><a href="#reacting-to-changes">Reacting to changes</a></li></ul><p><span class="toc-icon">🎯 </span><a href="#motivation"><strong>Motivation</strong></a></p>',articleContent:`<h1 id="introduction"><a class="markdown-permalink" href="#introduction"><span class="icon icon-link"></span></a>Introduction</h1><p>The central piece of Roqueform is the concept of a field. A field holds a value and provides a means to update it.</p><p>Let's start by creating a field:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">createField</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>roqueform<span class="pl-pds">'</span></span>;
...
</code></pre><p>Fields returned by the <a href="https://smikhalevski.github.io/roqueform/interfaces/roqueform.FieldCore.html#at"><code>Field.at</code> <sup>↗</sup></a> method have a stable identity. This means that you can invoke <code>at(key)</code> with the same key multiple times and the same field instance is returned:</p><pre><code class="language-ts"><span class="pl-smi">universeField</span>.<span class="pl-en">at</span>(<span class="pl-s"><span class="pl-pds">'</span>planets<span class="pl-pds">'</span></span>);
...
</code></pre><p>Plugins may publish their own events. Here's an example of the <a href="https://smikhalevski.github.io/roqueform/types/roqueform.FieldEventType.html"><code>errorAdded</code> <sup>↗</sup></a> event published by the <a href="#errors-plugin"><code>errorsPlugin</code></a>.</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">createField</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>roqueform<span class="pl-pds">'</span></span>;
...
</code></pre><p>To propagate the transient value contained by the child field to its parent, use the <a href="https://smikhalevski.github.io/roqueform/interfaces/roqueform.FieldCore.html#flushtransient"><code>Field.flushTransient</code> <sup>↗</sup></a> method:</p><pre><code class="language-ts"><span class="pl-smi">field</span>.<span class="pl-en">at</span>(<span class="pl-s"><span class="pl-pds">'</span>hello<span class="pl-pds">'</span></span>).<span class="pl-en">flushTransient</span>();
...
</code></pre><p><a href="https://smikhalevski.github.io/roqueforminterfaces/roqueform.FieldCore.html#settransientvalue"><code>Field.setTransientValue</code> <sup>↗</sup></a> can be called multiple times, but only the most recent update is propagated to the parent field after the <code>flushTransient</code> call.</p><p>When a child field is in a transient state, its value visible from the parent may differ from the actual value:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">planetsField</span> <span class="pl-k">=</span> <span class="pl-en">createField</span>([<span class="pl-s"><span class="pl-pds">'</span>Mars<span class="pl-pds">'</span></span>, <span class="pl-s"><span class="pl-pds">'</span>Pluto<span class="pl-pds">'</span></span>]);
...
</code></pre><p>To add an error to field, you can publish an <a href="https://smikhalevski.github.io/roqueform/types/roqueform.FieldEventType.html"><code>errorCaught</code> <sup>↗</sup></a> event instead of calling the<a href="https://smikhalevski.github.io/roqueform/interfaces/plugin_errors.ErrorsMixin.html#adderror"><code>addError</code> <sup>↗</sup></a> method:</p><pre><code class="language-ts"><span class="pl-smi">field</span>.<span class="pl-en">publish</span>({
...
</code></pre><h1 id="scroll-to-an-error-plugin"><a class="markdown-permalink" href="#scroll-to-an-error-plugin"><span class="icon icon-link"></span></a>Scroll to an error plugin</h1><p><a href="https://smikhalevski.github.io/roqueform/modules/plugin_scroll-to-error.html"><code>scrollToErrorPlugin</code> <sup>↗</sup></a> enhances the field with methods to scroll to the closest invalid field.</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">createField</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>roqueform<span class="pl-pds">'</span></span>;
...
<span class="pl-c">// ⮕ field.at('hello')</span>
</code></pre><p>This plugin works best in conjunction with the <a href="#errors-plugin"><code>errorsPlugin</code></a>. If the invalid field was associated with an element via <a href="https://smikhalevski.github.io/roqueform/interfaces/plugin_scroll-to-error.ScrollToErrorMixin.html#ref"><code>ref</code> <sup>↗</sup></a> than <code>scrollToError()</code> scrolls the viewport the reveal this element.</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">createField</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>roqueform<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">errorsPlugin</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>roqueform/plugin/errors<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">scrollToErrorPlugin</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>roqueform/plugin/scroll-to-error<span class="pl-pds">'</span></span>;
