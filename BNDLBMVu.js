...
</code></pre><p>You can use <code>forbidden()</code> in a <a href="#data-loading">data loader</a> or during rendering of a route component.</p>`};function d(){return s.createElement(n,{logo:s.createElement("div",{style:{...l(p,a),aspectRatio:830/470,backgroundRepeat:"no-repeat",backgroundSize:"contain",maxWidth:"100%",maxHeight:"100%",width:"20rem"},title:"React Corsair"}),readme:e})}export{d as default};
