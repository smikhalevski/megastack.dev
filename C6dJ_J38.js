...
</code></pre><p>Refer to <a href="#async-shapes">Async shapes</a> section for more details on when shapes can become asynchronous.</p><h1 id="early-return"><a class="markdown-permalink" href="#early-return"><span class="icon icon-link"></span></a>Early return</h1><p>By default, Doubter collects all issues during parsing. In some cases, you may want to halt parsing and raise a validation error as soon as the first issue was encountered. To do this, pass the <a href="https://smikhalevski.github.io/doubter/interfaces/core.ParseOptions.html#isearlyreturn"><code>isEarlyReturn</code> <sup>↗</sup></a> option to the <a href="#parsing-and-trying">parsing methods</a>.</p><pre><code class="language-ts"><span class="pl-smi">d</span>.<span class="pl-en">string</span>()
