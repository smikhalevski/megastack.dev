...
</code></pre><p><a href="https://smikhalevski.github.io/roqueforminterfaces/roqueform.FieldAPI.html#settransientvalue"><code>Field.setTransientValue</code><span class="external"></span></a> can be called multiple times, but only the most recent update is propagated to the parent field after the <code>Field.flushTransient</code> call.</p><p>When a child field is in a transient state, its value visible from the parent may differ from the actual value:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">planetsField</span> <span class="pl-k">=</span> <span class="pl-en">createField</span>([<span class="pl-s"><span class="pl-pds">'</span>Mars<span class="pl-pds">'</span></span>, <span class="pl-s"><span class="pl-pds">'</span>Pluto<span class="pl-pds">'</span></span>]);
...
<span class="pl-c">// ⮕ field.at('hello')</span>
</code></pre><p>This plugin works best in conjunction with the <a href="#errors-plugin"><code>errorsPlugin</code></a>. If the invalid field was associated with an element via <a href="https://smikhalevski.github.io/roqueform/interfaces/plugin_scroll-to-error.ScrollToErrorMixin.html#ref"><code>ref</code><span class="external"></span></a> than <a href="https://smikhalevski.github.io/roqueform/interfaces/plugin_scroll-to-error.ScrollToErrorMixin.html#scrolltoerror"><code>Field.scrollToError</code><span class="external"></span></a> scrolls the viewport the reveal this element.</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">createField</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>roqueform<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">errorsPlugin</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>roqueform/plugin/errors<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">scrollToErrorPlugin</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>roqueform/plugin/scroll-to-error<span class="pl-pds">'</span></span>;
...
</code></pre><p><code>Field.validate</code> sets <a href="https://smikhalevski.github.io/roqueform/interfaces/plugin_validation.ValidationMixin.html#validation"><code>validation</code><span class="external"></span></a> property for a field where it was called and to all of its descendants that hold a <a href="#transient-updates">non-transient</a> value:</p><pre><code class="language-ts"><span class="pl-smi">field</span>.<span class="pl-en">validate</span>();
...
</code></pre><p>The type of the field value is inferred from the provided shape, so the field value is statically checked.</p><p>When you call the <a href="https://smikhalevski.github.io/roqueform/interfaces/plugin_validation.ValidationMixin.html#validate"><code>Field.validate</code><span class="external"></span></a> method, it triggers validation of the field and all of its child fields:</p><pre><code class="language-ts"><span class="pl-c">// 🟡 Here an invalid value is set to the field</span>
<span class="pl-smi">field</span>.<span class="pl-en">at</span>(<span class="pl-s"><span class="pl-pds">'</span>hello<span class="pl-pds">'</span></span>).<span class="pl-en">setValue</span>(<span class="pl-s"><span class="pl-pds">'</span>universe<span class="pl-pds">'</span></span>);
...
</code></pre><p><code>useField</code> hook returns a <a href="https://smikhalevski.github.io/roqueform/types/roqueform.Field.html"><code>Field</code><span class="external"></span></a> instance that is preserved between re-renders. The <a href="https://smikhalevski.github.io/roqueform/functions/_roqueform_react.FieldRenderer.html"><code>&#x3C;FieldRenderer></code><span class="external"></span></a> component subscribes to the given field instance and re-renders children when an event is published by the field.</p><p>When a user updates the input value, the <code>rootField.at('hello')</code> value is set and <code>&#x3C;FieldRenderer></code> component is re-rendered.</p><p>If you pass a callback as an initial value, it would be invoked when the field is initialized.</p><pre><code class="language-ts"><span class="pl-en">useField</span>(() <span class="pl-k">=></span> <span class="pl-en">getInitialValue</span>());
