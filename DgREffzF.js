...
</code></pre><p><a href="https://smikhalevski.github.io/parallel-universe/classes/PubSub.html"><code>PubSub</code><span class="external"></span></a> can be used do decouple the lazy data source from the executor:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">PubSub</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>parallel-universe<span class="pl-pds">'</span></span>;
...
<span class="pl-smi">server</span>.<span class="pl-en">listen</span>(<span class="pl-c1">8080</span>);
</code></pre><p><code>hydrator</code> injects React Executor hydration chunks into the React stream.</p><p>In the <code>App</code> component, use the combination of <a href="https://react.dev/reference/react/Suspense"><code>&#x3C;Suspense></code><span class="external"></span></a>, <a href="https://smikhalevski.github.io/react-executor/functions/react-executor.useExecutor.html"><code>useExecutor</code><span class="external"></span></a> and <a href="https://smikhalevski.github.io/react-executor/functions/react-executor.useExecutorSuspense.html"><code>useExecutorSuspence</code><span class="external"></span></a> to suspend rendering while executors process their tasks:</p><pre><code class="language-tsx"><span class="pl-k">function</span> <span class="pl-en">App</span>() {
...
</code></pre><h2 id="invalidate-all-executors"><a class="markdown-permalink" href="#invalidate-all-executors"><span class="icon icon-link"></span></a>Invalidate all executors</h2><p><a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html#_iterator_"><code>ExecutorManager</code><span class="external"></span></a> is iterable and provides access to all executors that it has created. You can perform bach operations with all executors in for-loop:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">manager</span> <span class="pl-k">=</span> <span class="pl-en">useExecutorManager</span>();
