...
</code></pre><p>There are three types of history adapters that you can leverage:</p><ul><li><p><a href="https://smikhalevski.github.io/react-corsair/functions/history.createBrowserHistory.html"><code>createBrowserHistory</code> <sup>↗</sup></a> is a DOM-specific history adapter, useful in web browsers that support the HTML5 history API.</p></li><li><p><a href="https://smikhalevski.github.io/react-corsair/functions/history.createHashHistory.html"><code>createHashHistory</code> <sup>↗</sup></a> is a DOM-specific history adapter that stores location in a <a href="https://developer.mozilla.org/en-US/docs/Web/API/URL/hash">URL hash <sup>↗</sup></a>.</p></li><li><p><a href="https://smikhalevski.github.io/react-corsair/functions/history.createMemoryHistory.html"><code>createMemoryHistory</code> <sup>↗</sup></a> is an in-memory history adapter, useful in testing and non-DOM environments like SSR.</p></li></ul><h2 id="local-and-absolute-urls"><a class="markdown-permalink" href="#local-and-absolute-urls"><span class="icon icon-link"></span></a>Local and absolute URLs</h2><p>History provides two types of URL strings:</p><ul><li><p>Local URLs can be used as arguments for <a href="https://smikhalevski.github.io/react-corsair/interfaces/history.History.html#push"><code>push</code> <sup>↗</sup></a> and <a href="https://smikhalevski.github.io/react-corsair/interfaces/history.History.html#replace"><code>replace</code> <sup>↗</sup></a> methods.</p></li><li><p>Absolute URLs reflect <code>window.location.href</code>.</p></li></ul><p>All history adapters produce local URLs in the same way:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">helloRoute</span> <span class="pl-k">=</span> <span class="pl-en">createRoute</span>(<span class="pl-s"><span class="pl-pds">'</span>/hello<span class="pl-pds">'</span></span>);
...
<span class="pl-c">// ⮕ '/hello'</span>
</code></pre><p>A <a href="https://smikhalevski.github.io/react-corsair/interfaces/history.HistoryOptions.html#basepathname"><code>basePathname</code> <sup>↗</sup></a> can be prepended to an absolute URL:</p><pre><code class="language-ts"><span class="pl-en">createBrowserHistory</span>({ basePathname: <span class="pl-s"><span class="pl-pds">'</span>/wow<span class="pl-pds">'</span></span> }).<span class="pl-en">toAbsoluteURL</span>(<span class="pl-smi">helloRoute</span>);
...
<span class="pl-smi">server</span>.<span class="pl-en">listen</span>(<span class="pl-c1">8080</span>);
</code></pre><p>Router hydration chunks are streamed to the client along with chunks rendered by React.</p><h3 id="readable-web-streams-support"><a class="markdown-permalink" href="#readable-web-streams-support"><span class="icon icon-link"></span></a>Readable web streams support</h3><p>To enable streaming in a modern environment, use <a href="https://smikhalevski.github.io/react-corsair/classes/ssr.ReadableSSRRouter.html"><code>ReadableSSRRouter</code> <sup>↗</sup></a></p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">createServer</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>http<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">renderToPipeableStream</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-dom/server<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">RouterProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-corsair<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">createMemoryHistory</span>, <span class="pl-smi">HistoryProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-corsair/history<span class="pl-pds">'</span></span>;
...
</code></pre><p>Router hydration chunks are streamed to the client along with chunks rendered by React.</p><h2 id="state-serialization"><a class="markdown-permalink" href="#state-serialization"><span class="icon icon-link"></span></a>State serialization</h2><p>By default, route state is serialized using <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify"><code>JSON.stringify</code> <sup>↗</sup></a> which has quite a few limitations. If your route <a href="#data-loading">loads data</a> that may contain circular references, or non-serializable data like <code>BigInt</code>, use a custom state serialization.</p><p>On the client, pass a <a href="https://smikhalevski.github.io/react-corsair/interfaces/react-corsair.HydrateRouterOptions.html#stateparser"><code>stateParser</code> <sup>↗</sup></a> option to <code>hydrateRouter</code>:</p><pre><code class="language-tsx"><span class="pl-k">import</span> <span class="pl-smi">React</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">hydrateRoot</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-dom/client<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">createBrowserHistory</span>, <span class="pl-smi">HistoryProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-router/history<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">hydrateRouter</span>, <span class="pl-smi">Router</span>, <span class="pl-smi">RouterProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-router<span class="pl-pds">'</span></span>;
...
</code></pre><p>On the server, pass a <a href="https://smikhalevski.github.io/react-corsair/interfaces/ssr.SSRRouterOptions.html#statestringifier"><code>stateStringifier</code> <sup>↗</sup></a> option to <a href="#render-to-string"><code>SSRRouter</code></a>, <a href="#streaming-ssr"><code>PipeableSSRRouter</code></a>, or <a href="#readable-web-streams-support"><code>ReadableSSRRouter</code></a>, depending on your setup:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">ReadableSSRRouter</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-corsair/ssr<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">JSONMarshal</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>json-marshal<span class="pl-pds">'</span></span>;
...
</code></pre>`};function d(){return s.createElement(n,{logo:s.createElement("div",{style:{...l(p,a),aspectRatio:830/470,backgroundRepeat:"no-repeat",backgroundSize:"contain",maxWidth:"100%",maxHeight:"100%",width:"20rem"},title:"React Corsair"}),readme:e})}export{d as default};
