...
</code></pre><p>Clearing an executor removes the stored value and reason, but <em>doesn't</em> affect the pending task execution and preserves the <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#task">latest task<span class="external"></span></a> that was executed.</p><h1 id="events-and-lifecycle"><a class="markdown-permalink" href="#events-and-lifecycle"><span class="icon icon-link"></span></a>Events and lifecycle</h1><p>Executors publish various events when their state changes. To subscribe to executor events use the <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.Executor.html#subscribe"><code>subscribe</code><span class="external"></span></a> method:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">manager</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">ExecutorManager</span>();
...
</code></pre><p>On the client, pass <em>the same</em> <a href="https://smikhalevski.github.io/react-executor/interfaces/react-executor.HydrateExecutorManagerOptions.html#serializer"><code>serializer</code><span class="external"></span></a> to <code>hydrateExecutorManager</code>:</p><pre><code class="language-tsx"><span class="pl-k">import</span> <span class="pl-smi">React</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">hydrateRoot</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-dom/client<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> { <span class="pl-smi">hydrateExecutorManager</span>, <span class="pl-smi">ExecutorManager</span>, <span class="pl-smi">ExecutorManagerProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-executor<span class="pl-pds">'</span></span>;
<span class="pl-k">import</span> <span class="pl-smi">JSONMarshal</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>json-marshal<span class="pl-pds">'</span></span>;
...
</code></pre>`};function u(){return s.createElement(n,{logo:s.createElement("div",{style:l(p,a),className:e.Logo,title:"React Executor"}),readme:c})}export{u as default};
