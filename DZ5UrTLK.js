...
/>
</code></pre><p>This would output:</p><pre><code class="language-html">Hello, &#x3C;<span class="pl-ent">b</span>>
...
</code></pre><h2 id="iscaseinsensitivetags"><a class="markdown-permalink" href="#iscaseinsensitivetags"><span class="icon icon-link"></span></a><code>isCaseInsensitive​Tags</code></h2><p><strong>Default:</strong> <code>false</code></p><p>If <code>true</code> then [A-Z] characters are case-insensitive in tag names.</p><pre><code class="language-html">&#x3C;<span class="pl-ent">em</span>>&#x3C;/<span class="pl-ent">EM</span>> ⮕ &#x3C;<span class="pl-ent">em</span>>&#x3C;/<span class="pl-ent">em</span>>
                  ^^^
</code></pre><h2 id="isselfclosingtagsrecognized"><a class="markdown-permalink" href="#isselfclosingtagsrecognized"><span class="icon icon-link"></span></a><code>isSelfClosingTags​Recognized</code></h2><p><strong>Default:</strong> <code>false</code></p><p>If <code>true</code> then self-closing tags are recognized, otherwise they are treated as start tags.</p><pre><code class="language-html">&#x3C;<span class="pl-ent">link</span> />
      ^
...
</code></pre><p>This returns a <a href="https://smikhalevski.github.io/mfml/interfaces/mfml.MessageNode.html"><code>MessageNode</code> <sup>↗</sup></a> instance that looks like this:</p><pre><code class="language-json5">{
