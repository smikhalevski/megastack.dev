...
</code></pre><p>Now we need a <a href="https://smikhalevski.github.io/react-corsair/classes/react-corsair.Router.html"><code>Router</code></a> that would handle the navigation:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">Router</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-corsair<span class="pl-pds">'</span></span>;
...
</code></pre><p>To let the router know what route to render, call <a href="https://smikhalevski.github.io/react-corsair/classes/react-corsair.Router.html#navigate"><code>navigate</code></a>:</p><pre><code class="language-ts"><span class="pl-smi">router</span>.<span class="pl-c1">navigate</span>(<span class="pl-smi">helloRoute</span>);
</code></pre><p>Use <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.RouterProvider.html"><code>&#x3C;RouterProvider></code></a> to render the router:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">RouterProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-corsair<span class="pl-pds">'</span></span>;
...
<span class="pl-k">const</span> <span class="pl-c1">helloRoute</span> <span class="pl-k">=</span> <span class="pl-en">createRoute</span>(<span class="pl-s"><span class="pl-pds">'</span>/hello<span class="pl-pds">'</span></span>, <span class="pl-smi">HelloPage</span>);
</code></pre><p>In this example we used a shorthand signature of the <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.createRoute.html"><code>createRoute</code></a> function. You can also use a <a href="https://smikhalevski.github.io/react-corsair/interfaces/react-corsair.RouteOptions.html">route options object</a>:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">helloRoute</span> <span class="pl-k">=</span> <span class="pl-en">createRoute</span>({
...
</code></pre><p>To trigger navigation from inside a component, use the <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.useRouter.html"><code>useRouter</code></a> hook:</p><pre><code class="language-tsx"><span class="pl-k">function</span> <span class="pl-en">AnotherPage</span>() {
...
</code></pre><p>Router cannot create a location for a parameterized route by itself, because it doesn't know the required param values. So here's where <a href="https://smikhalevski.github.io/react-corsair/classes/react-corsair.Route.html#getlocation"><code>getLocation</code></a> comes handy:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">productLocation</span> <span class="pl-k">=</span> <span class="pl-smi">productRoute</span>.<span class="pl-en">getLocation</span>({ sku: <span class="pl-c1">42</span> });
...
</code></pre><p>To access params from a component use the <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.useRoute.html"><code>useRoute</code></a> hook:</p><pre><code class="language-tsx"><span class="pl-k">function</span> <span class="pl-en">ProductPage</span>() {
...
</code></pre><h2 id="outlets"><a class="markdown-permalink" href="#outlets"><span class="icon icon-link"></span></a>Outlets</h2><p>Route components are rendered inside an <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.Outlet.html"><code>&#x3C;Outlet></code></a>. If you don't provide children to <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.RouterProvider.html"><code>&#x3C;RouterProvider></code></a> then it would implicitly render an <code>&#x3C;Outlet></code>:</p><pre><code class="language-tsx"><span class="pl-k">import</span> { <span class="pl-smi">Router</span>, <span class="pl-smi">RouterProvider</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react-corsair<span class="pl-pds">'</span></span>;
...
</code></pre><p>Routes are <a href="#outlets">rendered inside outlets</a>, so <code>ParentPage</code> should render an <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.Outlet.html"><code>&#x3C;Outlet></code></a> to give place for a <code>ChildPage</code>:</p><pre><code class="language-tsx"><span class="pl-k">function</span> <span class="pl-en">ParentPage</span>() {
  <span class="pl-k">return</span> (
...
</code></pre><p>To allow router navigation to <code>childRoute</code> it should be listed among <a href="https://smikhalevski.github.io/react-corsair/interfaces/react-corsair.RouterOptions.html#routes"><code>routes</code></a>:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">router</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">Router</span>({ routes: [<span class="pl-smi">childRoute</span>] });
...
</code></pre><p>When router is navigated to the <code>userRoute</code>, a module that contains <code>&#x3C;UserPage></code> is loaded and rendered. The loaded component is cached, so next time the <code>userRoute</code> is matched, <code>&#x3C;UserPage></code> would be rendered instantly.</p><p>A promise is thrown if the <code>lazyComponent</code> isn't loaded yet. You can manually wrap <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.RouterProvider.html"><code>&#x3C;RouterProvider></code></a> in a custom <code>&#x3C;Suspense></code> boundary to catch it and render a fallback:</p><pre><code class="language-tsx"><span class="pl-k">function</span> <span class="pl-en">LoadingIndicator</span>() {
...
</code></pre><p><a href="https://smikhalevski.github.io/react-corsair/classes/react-corsair.Route.html#dataloader"><code>dataLoader</code></a> is called every time the router is navigated to <code>productRoute</code>. While data is being loaded, the <code>&#x3C;LoadingIndicator></code> is rendered instead of the <code>&#x3C;ProductPage></code>.</p><p>You can access the loaded data in your route component using the <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.useRoute.html"><code>useRoute</code></a> hook:</p><pre><code class="language-ts"><span class="pl-k">function</span> <span class="pl-en">ProductPage</span>() {
...
</code></pre><p>Some errors are recoverable and only require a route data or component to be <a href="https://smikhalevski.github.io/react-corsair/classes/react-corsair.RouteController.html#reload">reloaded</a>:</p><pre><code class="language-tsx"><span class="pl-k">function</span> <span class="pl-en">ErrorDetails</span>() {
...
</code></pre><p><code>notFound</code> throws the <a href="https://smikhalevski.github.io/react-corsair/variables/react-corsair.NOT_FOUND.html"><code>NOT_FOUND</code></a> symbol and aborts further rendering of the route component. The <code>&#x3C;Outlet></code> catches <code>NOT_FOUND</code> and renders a <a href="https://smikhalevski.github.io/react-corsair/interfaces/react-corsair.RouteOptions.html#notfoundcomponent"><code>notFoundComponent</code></a> as a fallback:</p><pre><code class="language-ts"><span class="pl-k">function</span> <span class="pl-en">ProductNotFound</span>() {
...
</code></pre><p>Router would render a <a href="https://smikhalevski.github.io/react-corsair/interfaces/react-corsair.RouteOptions.html#loadingcomponent"><code>loadingComponent</code></a> when <code>redirect</code> is called during a data loading or during rendering.</p><p><code>redirect</code> accepts routes, <a href="https://smikhalevski.github.io/react-corsair/interfaces/react-corsair.Location.html">locations</a>, and URL strings as an argument.</p><p>Rect Corsair doesn't have a default behavior for redirects. Use a router event listener to handle redirects:</p><pre><code class="language-ts"><span class="pl-k">const</span> <span class="pl-c1">router</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">Router</span>({ routes: [<span class="pl-smi">adminRoute</span>] });
...
</code></pre><p>If you want the browser history to drive your redirects, see the <a href="#history">History</a> section.</p><h2 id="prefetching"><a class="markdown-permalink" href="#prefetching"><span class="icon icon-link"></span></a>Prefetching</h2><p>Sometimes you know ahead of time that a user would visit a particular route, and you may want to prefetch the component and <a href="#data-loading">related data</a> so the navigation is instant.</p><p>To do this, call the <a href="https://smikhalevski.github.io/react-corsair/classes/react-corsair.Router.html#prefetch"><code>Router.prefetch</code></a> method and provide a route or a location to prefetch. Router would load required <a href="#code-splitting">components</a> and trigger <a href="#data-loading">data loaders</a>:</p><pre><code class="language-ts"><span class="pl-smi">router</span>.<span class="pl-en">prefetch</span>(<span class="pl-smi">productRoute</span>);
</code></pre><p>If a route requires params, use <a href="https://smikhalevski.github.io/react-corsair/classes/react-corsair.Route.html#getlocation"><code>getLocation</code></a> to create a prefetched location:</p><pre><code class="language-ts"><span class="pl-smi">router</span>.<span class="pl-en">prefetch</span>(<span class="pl-smi">user</span>.<span class="pl-en">getLocation</span>({ userId: <span class="pl-c1">42</span> }));
</code></pre><p>Use <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.Prefetch.html"><code>Prefetch</code></a> component for a more declarative route prefetching:</p><pre><code class="language-tsx">&#x3C;<span class="pl-c1">Prefetch</span> <span class="pl-e">to</span><span class="pl-k">=</span><span class="pl-pse">{</span><span class="pl-smi">productRoute</span><span class="pl-pse">}</span>/>
...
</code></pre><p>Now when user clicks on <em>Go to product</em>, the browser location changes to <code>/product/42</code> and <code>&#x3C;ShopPage></code> is re-rendered. <code>productRouteController</code> would contain a <a href="https://smikhalevski.github.io/react-corsair/classes/react-corsair.RouteController.html">route controller</a> for <code>productRoute</code>. This controller can be then rendered using the <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.RouteOutlet.html"><code>&#x3C;RouteOutlet></code></a>.</p><p>If a user clicks the <em>Reload</em> button in the browser, a <code>&#x3C;ProductPage></code> would be rendered because it matches <code>/product/42</code>.</p><p>You can render <code>&#x3C;RouteOutlet></code> in a popup to show the product preview, allowing user not to loose the context of the shop feed.</p><p>Use <a href="https://smikhalevski.github.io/react-corsair/classes/react-corsair.Router.html#cancelinterception"><code>cancelInterception</code></a> method to render the intercepted route in a router <code>&#x3C;Outlet></code>:</p><pre><code class="language-ts"><span class="pl-smi">router</span>.<span class="pl-en">cancelInterception</span>();
...
</code></pre><h1 id="server-side-rendering"><a class="markdown-permalink" href="#server-side-rendering"><span class="icon icon-link"></span></a>Server-side rendering</h1><p>Routes can be rendered on the server side and then hydrated on the client side.</p><p>To enable hydration on the client, create a <a href="https://smikhalevski.github.io/react-corsair/classes/react-corsair.Router.html"><code>Router</code></a> and call <a href="https://smikhalevski.github.io/react-corsair/functions/react-corsair.hydrateRouter.html"><code>hydrateRouter</code></a> instead of <a href="https://smikhalevski.github.io/react-corsair/classes/react-corsair.Router.html#navigate"><code>Router.navigate</code></a>:</p><pre><code class="language-tsx"><span class="pl-k">import</span> <span class="pl-smi">React</span> <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>react<span class="pl-pds">'</span></span>;
