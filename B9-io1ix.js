...
</code></pre><p>Evergreen plugin keeps track of downloaded bundles:</p><ul><li>The master bundle contains current assets of the web app;</li><li>The pending update bundle contains assets that were downloaded but not yet applied as master.</li></ul><p>Below is the diagram of events posted by the evergreen plugin.</p><pre><code class="language-mermaid"><span class="pl-k">graph</span> <span class="pl-c1">TD</span>

<span class="pl-ent">start</span><span class="pl-s"><span class="pl-sg">[</span><span class="pl-pds">"</span>start(version, updateMode)<span class="pl-pds">"</span><span class="pl-sg">]</span></span>
<span class="pl-k">--></span> <span class="pl-ent">HasMasterBundle</span>

<span class="pl-ent">HasMasterBundle</span><span class="pl-s"><span class="pl-sg">{{</span>Has master bundle?<span class="pl-sg">}}</span></span>
<span class="pl-k">-->|</span><span class="pl-s">Yes</span><span class="pl-k">|</span> <span class="pl-ent">IsSameVersionAsMasterBundle</span><span class="pl-s"><span class="pl-sg">{{</span>Is same version as master bundle?<span class="pl-sg">}}</span></span>

<span class="pl-ent">HasMasterBundle</span>
<span class="pl-k">-->|</span><span class="pl-s">No</span><span class="pl-k">|</span> <span class="pl-ent">MandatoryUpdate</span>

<span class="pl-ent">IsSameVersionAsMasterBundle</span>
<span class="pl-k">-->|</span><span class="pl-s">Yes</span><span class="pl-k">|</span> <span class="pl-ent">MainBundleReadyEvent</span><span class="pl-s"><span class="pl-sg">([</span>BundleReadyEvent<span class="pl-sg">])</span></span>

<span class="pl-ent">IsSameVersionAsMasterBundle</span>
<span class="pl-k">-->|</span><span class="pl-s">No</span><span class="pl-k">|</span> <span class="pl-ent">HasPendingUpdateBundle</span><span class="pl-s"><span class="pl-sg">{{</span>Has pending update bundle?<span class="pl-sg">}}</span></span>

<span class="pl-ent">HasPendingUpdateBundle</span>
<span class="pl-k">-->|</span><span class="pl-s">Yes</span><span class="pl-k">|</span> <span class="pl-ent">IsSameVersionAsPendingUpdateBundle</span><span class="pl-s"><span class="pl-sg">{{</span>Is same version as pending update bundle?<span class="pl-sg">}}</span></span>

<span class="pl-ent">IsSameVersionAsPendingUpdateBundle</span>
<span class="pl-k">-->|</span><span class="pl-s">Yes</span><span class="pl-k">|</span> <span class="pl-ent">MainBundleReadyEvent</span>

<span class="pl-ent">IsSameVersionAsPendingUpdateBundle</span>
<span class="pl-k">-->|</span><span class="pl-s">No</span><span class="pl-k">|</span> <span class="pl-ent">IsMandatoryUpdateMode</span>

<span class="pl-ent">HasPendingUpdateBundle</span>
<span class="pl-k">-->|</span><span class="pl-s">No</span><span class="pl-k">|</span> <span class="pl-ent">IsMandatoryUpdateMode</span><span class="pl-s"><span class="pl-sg">{{</span>Is mandatory update mode?<span class="pl-sg">}}</span></span>

<span class="pl-ent">IsMandatoryUpdateMode</span>
<span class="pl-k">---|</span><span class="pl-s">No</span><span class="pl-k">|</span> <span class="pl-ent">BundleReadyEvent</span><span class="pl-s"><span class="pl-sg">([</span><span class="pl-pds">"</span>BundleReadyEvent ¹<span class="pl-pds">"</span><span class="pl-sg">])</span></span>
<span class="pl-k">--></span> <span class="pl-ent">OptionalUpdate</span>

<span class="pl-ent">IsMandatoryUpdateMode</span>
<span class="pl-k">--->|</span><span class="pl-s">Yes</span><span class="pl-k">|</span> <span class="pl-ent">MandatoryUpdate</span>

<span class="pl-k">subgraph</span> <span class="pl-en">OptionalUpdate</span> <span class="pl-s"><span class="pl-sg">[</span>Optional update<span class="pl-sg">]</span></span>
<span class="pl-ent">OptionalUpdateStartedEvent</span><span class="pl-s"><span class="pl-sg">([</span>UpdateStartedEvent<span class="pl-sg">])</span></span>
<span class="pl-k">--></span> <span class="pl-ent">OptionalUpdateProgressEvent</span><span class="pl-s"><span class="pl-sg">([</span>UpdateProgressEvent<span class="pl-sg">])</span></span>
<span class="pl-k">--></span> <span class="pl-ent">OptionalUpdateReadyEvent</span><span class="pl-s"><span class="pl-sg">([</span>UpdateReadyEvent<span class="pl-sg">])</span></span>
<span class="pl-k">end</span>

<span class="pl-k">subgraph</span> <span class="pl-en">MandatoryUpdate</span> <span class="pl-s"><span class="pl-sg">[</span>Mandatory update<span class="pl-sg">]</span></span>
<span class="pl-ent">MandatoryUpdateStartedEvent</span><span class="pl-s"><span class="pl-sg">([</span>UpdateStartedEvent<span class="pl-sg">])</span></span>
<span class="pl-k">--></span> <span class="pl-ent">MandatoryUpdateProgressEvent</span><span class="pl-s"><span class="pl-sg">([</span>UpdateProgressEvent<span class="pl-sg">])</span></span>
<span class="pl-k">--></span> <span class="pl-ent">MandatoryBundleReadyEvent</span><span class="pl-s"><span class="pl-sg">([</span>BundleReadyEvent<span class="pl-sg">])</span></span>
<span class="pl-k">end</span>
</code></pre><p>¹ The app is started with the assets from the available master bundle while the update is downloaded in the background.</p><p>You can monitor background updates and apply them as soon as they are ready:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">evergreenManager</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>racehorse<span class="pl-pds">'</span></span>;
...
<span class="pl-k">const</span> <span class="pl-c1">uri</span> <span class="pl-k">=</span> <span class="pl-smi">fsManager</span>.<span class="pl-c1">resolve</span>(<span class="pl-smi">Directory</span>.<span class="pl-c1">CACHE</span>, <span class="pl-s"><span class="pl-pds">'</span>temp.txt<span class="pl-pds">'</span></span>);

<span class="pl-k">const</span> <span class="pl-c1">file</span> <span class="pl-k">=</span> <span class="pl-smi">fsManager</span>.<span class="pl-en">File</span>(<span class="pl-smi">uri</span>);
...
<span class="pl-k">const</span> <span class="pl-c1">photoUrl</span> <span class="pl-k">=</span> <span class="pl-smi">fsManager</span>.<span class="pl-en">File</span>(<span class="pl-smi">contact</span>.<span class="pl-smi">photoUri</span>).<span class="pl-smi">localUrl</span>;
