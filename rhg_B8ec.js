...
/>
</code></pre><p>This would output:</p><!-- prettier-ignore --><pre><code class="language-html">Hello, &#x3C;<span class="pl-ent">b</span>>
    &#x3C;<span class="pl-ent">UserAvatar</span>>Bob&#x3C;/<span class="pl-ent">UserAvatar</span>>
...
/>
</code></pre><p>This would output:</p><!-- prettier-ignore --><pre><code class="language-html">Final offer:
...
</code></pre><h1 id="devtool"><a class="markdown-permalink" href="#devtool"><span class="icon icon-link"></span></a>Devtool</h1><p>MFML provides the devtool for React DOM applications. To enable it, call <a href="https://smikhalevski.github.io/mfml/functions/mfml_react.enableDevtool.html"><code>enableDevtool</code> <sup>↗</sup></a> anywhere in your client-side code (on the server-side it is a no-op):</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">enableDevtool</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml/react<span class="pl-pds">'</span></span>;

<span class="pl-k">import</span>(<span class="pl-s"><span class="pl-pds">'</span>@mfml/messages/metadata<span class="pl-pds">'</span></span>).<span class="pl-c1">then</span>(<span class="pl-v">module</span> <span class="pl-k">=></span> {
  <span class="pl-en">enableDevtool</span>(<span class="pl-c1">module</span>.<span class="pl-smi">default</span>);
});
</code></pre><p>Here <a href="#packagename"><code>@mfml/messages</code></a> is a package generated by the <code>mfml</code> compiler. Metadata exported by this package may have substantial size, so it is recommended to split it into a separate chunk.</p><p>To use the devtool, press and hold the <kbd>Alt</kbd> key (or <kbd>Option</kbd> key on Mac), then hover over a rendered message text to reveal the related message information.</p><h1 id="configuration"><a class="markdown-permalink" href="#configuration"><span class="icon icon-link"></span></a>Configuration</h1><p>When running <code>mfml</code> from the command line, MFML will automatically try to resolve a config file named <code>mfml.config.js</code> inside the <code>cwd</code> (other JS and TS extensions are also supported).</p><p>The most basic config file looks like this:</p><pre><code class="language-ts"><span class="pl-k">import</span> { <span class="pl-smi">defineConfig</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>mfml/compiler<span class="pl-pds">'</span></span>;
