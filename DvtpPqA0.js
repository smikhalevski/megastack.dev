...
</code></pre><p>Each executor has a unique key in the scope of the manager. Here we created the new executor with the key <code>'rooky'</code>. Managers create a new executor when you call <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html#getorcreate"><code>getOrCreate</code><span class="external"></span></a> with a new key. Each consequent call with that key returns the same executor.</p><p>If you want to retrieve an existing executor by its key and don't want to create a new executor if it doesn't exist, use <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html#get"><code>get</code><span class="external"></span></a>:</p><pre><code class="language-ts"><span class="pl-smi">manager</span>.<span class="pl-c1">get</span>(<span class="pl-s"><span class="pl-pds">'</span>bobby<span class="pl-pds">'</span></span>);
...
</code></pre><h2 id="global-loading-indicator"><a class="markdown-permalink" href="#global-loading-indicator"><span class="icon icon-link"></span></a>Global loading indicator</h2><p>To detect a global pending state we can rely on events published by an <a href="https://smikhalevski.github.io/react-executor/classes/react-executor.ExecutorManager.html"><code>ExecutorManager</code><span class="external"></span></a>:</p><pre><code class="language-ts"><span class="pl-k">function</span> <span class="pl-en">useGlobalPending</span>(<span class="pl-en">predicate</span> <span class="pl-k">=</span> (<span class="pl-v">executor</span><span class="pl-k">:</span> <span class="pl-en">Executor</span>) <span class="pl-k">=></span> <span class="pl-c1">true</span>)<span class="pl-k">:</span> <span class="pl-c1">boolean</span> {
